Feature: UA2 Front End Automation
  ...
  Scenario Outline: Create USER (<Scenario Description>)
    ...
    Examples: 
      ...
      | PTA User                         | autoptauser@mailinator.com             | Testing1 | FirstName | LastName | test.automatemail |       | Executive                       | Internal support, Episodes, Episodes 2.0, Reports, Lessons,Share File                                    | 1234567890 | MLKWikk1JDA1                   | Stamford Hospital |
      | PTA User                         | autoptauser@mailinator.com             | Testing1 | FirstName | LastName | test.automatemail |       | Manager                         | Episodes, Episodes 2.0, Reports, Lessons,Share File                                                      | 1234567890 | MLKWikk1JDA1                   | Stamford Hospital |
      | PTA User                         | autoptauser@mailinator.com             | Testing1 | FirstName | LastName | test.automatemail |       | Case Manager                    | Episodes, Episodes 2.0, Reports, Lessons,Share File                                                      | 1234567890 | MLKWikk1JDA1                   | Stamford Hospital |
      | PTA User                         | autoptauser@mailinator.com             | Testing1 | FirstName | LastName | test.automatemail |       | Physicians                      | Episodes, Episodes 2.0, Reports, Lessons,Share File, Physician connect                                   | 1234567890 | MLKWikk1JDA1                   | Stamford Hospital |
