Feature: Edit page for Downstream provider
  ...
  Scenario Outline: Edit downstream provider general details, applications and data permissions
    ...
    Examples: 
      ...
      | Super Admin | test.automatemail | Downstream Provider | FirstNameEdited | LastNameEdited | 996-385-2451 | Episodes            | Episodes 2.0 | Episodes, Administration, Physician Connect, Reports, Lessons | Stamford Memorial Hospital | 345454, 5 Star Home Care Llc, 3 Angels Home Health | Downstream Provider | Covenant       | 3056-804--Catered Manor Nursing Center, 3056-805--Downey Care Center | 3056-809--Courtyard Health Care Center, 3056-810--Emerald Gardens Nursing Center | Healthsystem - Downstream Provider, Covenant | Covenant--BPCI Model 3, Healthsystem - Downstream Provider--Downstream Organization | Covenant--3056-809--Courtyard Health Care Center, Covenant--3056-810--Emerald Gardens Nursing Center, Healthsystem - Downstream Provider--DOWN-ORG--345454, Healthsystem - Downstream Provider--DOWN-ORG--5 Star Home Care Llc, Healthsystem - Downstream Provider--DOWN-ORG--3 Angels Home Health, Healthsystem - Downstream Provider--DOWN-ORG--Stamford Memorial Hospital Home Health Care, Healthsystem - Downstream Provider--DOWN-ORG--Stamford Medical Clinic Llc, Healthsystem - Downstream Provider--DOWN-ORG--Stamford Hospital Snf | ROLE_SNF | Patient ID     | Episode DRG Issues [Model 3] | i am learning path, Learning Pathway 2, Remedy University |      | Courtyard Health Care Center, Emerald Gardens Nursing Center, litchford Falls Healthcare Re, 5 Star Home Care Llc, 3 Angels Home Health, Stamford Memorial Hospital Home Health Care, Stamford Medical Clinic Llc, Stamford Hospital Snf |
  ...
  Scenario Outline: Remove exiting health System and new org
    ...
    Examples: 
      ...
      | Super Admin | test.automatemail | Downstream Provider | FirstNameEdited | LastNameEdited | 996-385-2451 | Episodes          | Episodes, Episodes 2.0 | Administration, Physician Connect, Reports, Lessons | Covenant            | Yes              | Adcare Health  | 3056-343--Coosa Valley Health Care | Healthsystem - Downstream Provider, Adcare Health | Adcare Health--BPCI Model 3, Healthsystem - Downstream Provider--Downstream Organization | Adcare Health--3056-343--Coosa Valley Health Care, Healthsystem - Downstream Provider--DOWN-ORG--345454, Healthsystem - Downstream Provider--DOWN-ORG--5 Star Home Care Llc, Healthsystem - Downstream Provider--DOWN-ORG--3 Angels Home Health, Healthsystem - Downstream Provider--DOWN-ORG--Stamford Memorial Hospital Home Health Care, Healthsystem - Downstream Provider--DOWN-ORG--Stamford Medical Clinic Llc, Healthsystem - Downstream Provider--DOWN-ORG--Stamford Hospital Snf | ROLE_SNF | Patient ID     | Episode DRG Issues [Model 3] | i am learning path, Learning Pathway 2, Remedy University |      | Coosa valley health care, litchford Falls Healthcare Re, 5 Star Home Care Llc, 3 Angels Home Health, Stamford Memorial Hospital Home Health Care, Stamford Medical Clinic Llc, Stamford Hospital Snf |

  Scenario Outline: Change Role from <PreviousRole> to <Role>, and enabling same model3 org and locations
    Given I am on the login page
    When I log in as super user
    Then I should see Tile text User Admin
    And I click on the "User Admin" tile
