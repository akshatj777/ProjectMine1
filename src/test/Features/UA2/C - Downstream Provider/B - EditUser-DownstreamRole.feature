Feature: Edit page for Downstream provider
  ...
  Scenario Outline: Change Role from <PreviousRole> to <Role>, and enabling same model3 org and locations
    ...
    Examples: 
      ...
      | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstNameEdited | LastNameEdited | test.automatemail |     | Downstream Provider | Executive | Episodes            | Reports, Lessons   | Reports, Lessons | Administration, Physician Connect, Episodes 2.0 | Test123             | i am learning path, Learning Pathway 2 | ROLE_PRM | Adcare Health | BPCI-Model3 | 3056-343--Coosa Valley Health Care | Patient ID     | Episode DRG Issues |      | Coosa Valley Health Care | i am learning path, Learning Pathway 2 | Adcare Health--BPCI Model 3 | Adcare Health--3056-343--Coosa Valley Health Care |
