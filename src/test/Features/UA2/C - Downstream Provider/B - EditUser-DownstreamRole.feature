Feature: Edit page for Downstream provider
  ...
  Scenario Outline: Remove exiting health System and new org
    ...
    Examples: 
      ...
      | Super Admin | test.automatemail | Downstream Provider | FirstNameEdited | LastNameEdited | 996-385-2451 | Episodes          | Episodes, Episodes 2.0 | Administration, Physician Connect, Reports, Lessons | Covenant            | Yes              | Apple Rehab    | 3056-i11--Apple - Watertown | Healthsystem - Downstream Provider, Apple Rehab | Apple Rehab--BPCI Model 3, Healthsystem - Downstream Provider--Downstream Organization | Apple Rehab--3056-i11--Apple - Watertown, Healthsystem - Downstream Provider--DOWN-ORG--345454, Healthsystem - Downstream Provider--DOWN-ORG--5 Star Home Care Llc, Healthsystem - Downstream Provider--DOWN-ORG--3 Angels Home Health, Healthsystem - Downstream Provider--DOWN-ORG--Stamford Memorial Hospital Home Health Care, Healthsystem - Downstream Provider--DOWN-ORG--Stamford Medical Clinic Llc, Healthsystem - Downstream Provider--DOWN-ORG--Stamford Hospital Snf | ROLE_SNF | Patient ID     | Episode DRG Issues [Model 3] | i am learning path, Learning Pathway 2, Remedy University |      | Apple - Watertown, litchford Falls Healthcare Re, 5 Star Home Care Llc, 3 Angels Home Health, Stamford Memorial Hospital Home Health Care, Stamford Medical Clinic Llc, Stamford Hospital Snf |
