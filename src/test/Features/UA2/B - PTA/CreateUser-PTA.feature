Feature: UA2 Front End Automation
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                             | User                            | UserName          | FirstName  | LastName | Email             | Phone | Role                      | Applications | ApplicationsNotVisible | NPI | LearningPathwaySearchParameter | Health System     | Programs    |
      | Login with PTA user and create user with Executive role                 | Partner Technical Administrator | chloe@yopmail.com | FirstNameA | LastName | test.automatemail |       | Executive                 | Reports      |                        |     | Learning Pathway 2             | Stamford Hospital | BPCI-Model2 |
      | Login with PTA user and create user with Manager role                   | Partner Technical Administrator | chloe@yopmail.com | FirstNameB | LastName | test.automatemail |       | Manager                   | Reports      |                        |     | Learning Pathway 2             | Stamford Hospital | BPCI-Model2 |
      | Login with PTA user and create user with Case Manager role              | Partner Technical Administrator | chloe@yopmail.com | FirstNameC | LastName | test.automatemail |       | Case Manager              | Reports      |                        |     | Learning Pathway 2             | Stamford Hospital | BPCI-Model2 |
      | Login with PTA user and create user with Physicians role                | Partner Technical Administrator | chloe@yopmail.com | FirstNameD | LastName | test.automatemail |       | Physicians                | Reports      |                        | NPI | Learning Pathway 2             | Stamford Hospital | BPCI-Model2 |
      | Login with PTA user and create user with Transitional Case Manager role | Partner Technical Administrator | chloe@yopmail.com | FirstNameE | LastName | test.automatemail |       | Transitional Case Manager | Reports      |                        |     | Learning Pathway 2             | Stamford Hospital | BPCI-Model2 |
