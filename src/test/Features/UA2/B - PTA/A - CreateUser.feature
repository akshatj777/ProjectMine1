Feature: Create User - PTA User
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with Partner Technical Administrator User and create user with Executive role                 | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName      | LastNameLastNameLastNameLastNameLastName | test.automatemail | 9988776655 | Executive                 | Episodes                             | Episodes 2.0, Administration, Physician Connect, TCI |     | Care Coordination External, Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | RWJ Barnabas Health, INC | BPCI-CJR                 | CJR-10-6--Monmouth Medical Center - Southern Campus                                                       |                  |                |           |            |                  |                |           |            |
      | Login with Partner Technical Administrator User and create user with Manager role                   | Partner Technical Administrator | FirstName                                 | lastnamelastnamelastnamelastnamelastname | test.automatemail |            | Manager                   | Episodes, Reports                    | Episodes 2.0, Administration, Physician Connect, TCI |     | 5HDc3E6aK_E1, p11D0Vl2FSg1, qfy2xp8zSFc1, 18h7phZr1h81, n9yn5n0Qa581                                                                                                         | TeamHealth               | BPCI-Model2              | 2070-g14--North Shore Med Center                                                                          |                  |                |           |            |                  |                |           |            |
      | Login with Partner Technical Administrator User and create user with Case Manager role              | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName      | LastName                                 | test.automatemail |            | Case Manager              | Episodes, Lessons                    | Episodes 2.0, Administration, Physician Connect, TCI |     | Care Coordination External, Clinical Operations Acute Care Hospital Model 2, qfy2xp8zSFc1, 18h7phZr1h81, n9yn5n0Qa581                                                        | TeamHealth               | BPCI-Model2              | All Locations                                                                                             |                  |                |           |            |                  |                |           |            |
      | Login with Partner Technical Administrator User and create user with Physicians role                | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName      | LastNameLastNameLastNameLastNameLastName | test.automatemail | 9988776655 | Physicians                | Episodes, Reports, Physician Connect | Episodes 2.0, Administration, TCI                    | NPI | 5HDc3E6aK_E1, p11D0Vl2FSg1, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University                                                  | TeamHealth               | BPCI-Model2, BPCI-Model3 | 2070-g14--North Shore Med Center, 3056-q91--Rhea Medical Center, 3056-q91--The Medical Center At Franklin |                  |                |           |            |                  |                |           |            |
      | Login with Partner Technical Administrator User and create user with Transitional Case Manager role | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstNameFirst | LastName                                 | test.automatemail | 9988776655 | Transitional Case Manager | Reports                              | Episodes 2.0,Administration, Physician Connect, TCI  |     | 5HDc3E6aK_E1, Remedy University                                                                                                                                              | RWJ Barnabas Health, INC | BPCI-CJR                 | All Locations                                                                                             |                  |                |           |            |                  |                |           |            |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with Executive and verify Product Tiles and their redirections                 | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName      | LastNameLastNameLastNameLastNameLastName | Executive                 | Episodes, TCI                             | Episodes 2.0, Reports, Lessons, Administration, Physician Connect  | ROLE_PRM       | Patient ID     | Episode DRG Issues |      | Care Coordination External, Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | Monmouth Medical Center - Southern Campus                                                                                                                                   |
      | Login with Manager and verify Product Tiles and their redirections                   | Partner Technical Administrator | FirstName                                 | LastNameLastNameLastNameLastNameLastName | Manager                   | Episodes, Reports, TCI                    | Episodes 2.0, Administration, Physician Connect, Lessons           | ROLE_PRM       | Patient ID     | Episode DRG Issues |      | Care Coordination External, Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | North Shore Med Center                                                                                                                                                      |
      | Login with Case Manager and verify Product Tiles and their redirections              | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName      | LastName                                 | Case Manager              | Episodes, TCI                             | Episodes 2.0, Administration, Physician Connect, Reports           | ROLE_TCS       | Patient ID     | Episode DRG Issues |      | Care Coordination External, Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | North Shore Med Center, Mercy Hospital, Baptist Medical Center  Beaches                                                                                                     |
      | Login with Physicians and verify Product Tiles and their redirections                | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName      | LastNameLastNameLastNameLastNameLastName | Physicians                | Episodes, Reports, Physician Connect, TCI | Episodes 2.0, Administration, Lessons                              | ROLE_CLINICIAN | Patient ID     | Episode DRG Issues |      | Care Coordination External, Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | North Shore Med Center, Rhea Medical Center, The Medical Center At Franklin                                                                                                 |
      | Login with Transitional Case Manager and verify Product Tiles and their redirections | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstNameFirst | LastName                                 | Transitional Case Manager | Reports, TCI                              | Episodes, Episodes 2.0, Administration, Physician Connect, Lessons | ROLE_TCS       | Patient ID     | Episode DRG Issues |      | Care Coordination External, Remedy University                                                                                                                                | Monmouth Medical Center - Southern Campus, RWJ University Hospital at New Brunswick, RWJ University Hospital at Somerset, Robert Wood Johnson University Hospital At Rahway |
