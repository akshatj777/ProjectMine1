Feature: Edit user page for PTA
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Edit single to multiple program                    | Partner Technical Administrator | Manager | test.automatemail | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect |                | BPCI-Model3 |                 | 3090-066--Herrin Hospital                                     | Herrin Hospital, Evanston Hospital        | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | FirstName | LastNameLastNameLastNameLastNameLastName | ROLE_PRM | Patient ID     | Episode DRG Issues [Model 3] | Sound Physicians       | Sound Physicians--BPCI Model 3, Sound Physicians--BPCI Model 2 | Sound Physicians--6005-059--Evanston Hospital, Sound Physicians--3090-066--Herrin Hospital        |
      | Edit multiple to single program                    | Partner Technical Administrator | Manager | test.automatemail | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect | BPCI-Model3    |             |                 |                                                               | Evanston Hospital                         | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | FirstName | LastNameLastNameLastNameLastNameLastName | ROLE_PRM | Patient ID     | Episode DRG Issues           | Sound Physicians       | Sound Physicians--BPCI Model 2                                 | Sound Physicians--6005-059--Evanston Hospital                                                     |
      | Remove existing Program and select another Program | Partner Technical Administrator | Manager | test.automatemail | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect | BPCI-Model2    | BPCI-Model3 |                 | 3090-066--Herrin Hospital, 3056-b75--Warren Memorial Hospital | Herrin Hospital, Warren Memorial Hospital | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | FirstName | LastNameLastNameLastNameLastNameLastName | ROLE_PRM | Patient ID     | Episode DRG Issues [Model 3] | Sound Physicians       | Sound Physicians--BPCI Model 3                                 | Sound Physicians--3090-066--Herrin Hospital, Sound Physicians--3056-b75--Warren Memorial Hospital |
