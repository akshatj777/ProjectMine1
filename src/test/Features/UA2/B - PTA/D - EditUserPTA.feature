Feature: Edit user page for PTA
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with Partner Technical Administrator User and create user with Executive role | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName | LastNameLastNameLastNameLastNameLastName | test.automatemail | 9988776655 | Executive | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect, TCI |     | Care Coordination External, Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2 | Butler Memorial Hospital | BPCI-Model2 | 2070-a55--Butler Memorial Hospital     |                  |                |           |            |                  |                |           |            |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Edit single to multiple program and all locations                                 | Partner Technical Administrator | Executive | test.automatemail | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect | Episodes,Episodes  |                | BPCI-CJR    |                 | All Locations                                                                   | Butler Memorial Hospital                                                                          | Catered Manor Nursing Center, Downey Care Center, Encinitas Nursing and Rehabilitation Center                                                    | FirstNameFirstNameFirstNameFirstName | LastNameLastNameLastNameLastNameLastName | ROLE_PRM | Patient ID     | Episode DRG Issues           | Butler Memorial Hospital | Butler Memorial Hospital--BPCI Model 2, Butler Memorial Hospital--BPCI-CJR | Butler Memorial Hospital--2070-a55--Butler Memorial Hospital, Butler Memorial Hospital--CJR-1--Butler Memorial Hospital                                                               |
      | Edit multiple to single program                                                   | Partner Technical Administrator | Executive | test.automatemail | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect | Episodes,Episodes  | BPCI-Model2    |             |                 |                                                                                 | Butler Memorial Hospital                                                                          | Catered Manor Nursing Center, Downey Care Center, Encinitas Nursing and Rehabilitation Center                                                    | FirstNameFirstNameFirstNameFirstName | LastNameLastNameLastNameLastNameLastName | ROLE_PRM | Patient ID     | Episode DRG Issues           | Butler Memorial Hospital | Butler Memorial Hospital--BPCI-CJR                                         | Butler Memorial Hospital--CJR-1--Butler Memorial Hospital                                                                                                                             |
