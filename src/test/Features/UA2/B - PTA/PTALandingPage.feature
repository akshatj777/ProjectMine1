Feature: Landing page verification
  ...
  Scenario Outline: Search a non-provisioned user from PTA
    Given I am on the login page
    Then I enter email field UserName for login
    And I enter password field Testing1 for Login
    Then I click Access button
    ...
    Examples: 
      | UserName                        | user                            | Role                            |
      | Partner Technical Administrator | Partner Technical Administrator | Partner Technical Administrator |
      | Partner Technical Administrator | Partner Technical Administrator | Downstream Provider             |
  ...
  Scenario Outline: Edit Role from non-provisioned role-<PreviousRole> to provisioned role-<Role> and search
    ...
    Examples: 
      | UserName                        | Email             | user                            | PreviousRole        | Role       | NPI | Applications                                                | LearningPathwaySearchParameter |
      | Partner Technical Administrator | test.automatemail | Partner Technical Administrator | Remedy Other        | Manager    |     | Episodes, Episodes 2.0, Reports, Lessons                    | Learning Pathway 2             |
      | Partner Technical Administrator | test.automatemail | Partner Technical Administrator | Downstream Provider | Physicians |     | Episodes, Episodes 2.0, Reports, Lessons, Physician connect | Learning Pathway 2             |
  ...
  Scenario Outline: Edit Role from provisioned role-<PreviousRole> to non-provisioned role-<Role> and search
    ...
    Examples: 
      | UserName                        | Email             | user                            | PreviousRole | Role                | NPI | Applications                                  | LearningPathwaySearchParameter |
      | Partner Technical Administrator | test.automatemail | Partner Technical Administrator | Executive    | Remedy TCS          |     | Episodes, Episodes 2.0, Reports, Lessons, TCI | Learning Pathway 2             |
      | Partner Technical Administrator | test.automatemail | Partner Technical Administrator | Case Manager | Downstream Provider |     | Episodes, Episodes 2.0                        | Learning Pathway 2             |
