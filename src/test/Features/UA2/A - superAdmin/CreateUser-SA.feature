Feature: Create User - Super Admin User
  ...
  | Login with Executive and verify Product Tiles and their redirections                       | Super Admin | Executive                       | Episodes, Episodes 2.0, Reports                                         | Administration, Physician Connect                                  | ROLE_PRM       | Stamford Hospital |
  | Login with Manager and verify Product Tiles and their redirections                         | Super Admin | Manager                         | Episodes, Episodes 2.0, Reports                                         | Administration, Physician Connect                                  | ROLE_PRM       | Stamford Hospital |
  | Login with Case Manager and verify Product Tiles and their redirections                    | Super Admin | Case Manager                    | Episodes, Episodes 2.0, Reports                                         | Administration, Physician Connect                                  | ROLE_TCS       | Stamford Hospital |
  | Login with Physicians and verify Product Tiles and their redirections                      | Super Admin | Physicians                      | Episodes, Episodes 2.0, Reports, Physician Connect                      | Administration                                                     | ROLE_CLINICIAN | Stamford Hospital |
  ...
  #| Login with Prospective Partner Executive and verify Product Tiles and their redirections   | Super Admin | Prospective Partner Executive   |                                                                           | Administration, Physician Connect, Episodes, Episodes 2.0, Reports |                | Stamford Hospital |
  ...
  | Login with Partner Program Administrator and verify Product Tiles and their redirections   | Super Admin | Partner Program Administrator   | Episodes, Episodes 2.0, Reports, Physician Connect                      | Administration                                                     | ROLE_PRM       | Stamford Hospital |
  | Login with Remedy Program Administrator and verify Product Tiles and their redirections    | Super Admin | Remedy Program Administrator    | Episodes, Episodes 2.0, Reports, Physician Connect, TCI                 | Administration                                                     | ROLE_PRM       | Stamford Hospital       | Login with Remedy Technical Administrator and verify Product Tiles and their redirections  | Super Admin | Remedy Technical Administrator  | Episodes, Episodes 2.0, Reports, Lessons, Physician Connect, Administration, TCI |                                                                    | ROLE_ADMIN     | Stamford Hospital |
  | Login with Transitional Case Manager and verify Product Tiles and their redirections       | Super Admin | Transitional Case Manager       | Episodes, Reports                                                       | Episodes 2.0, Administration, Physician Connect                    | ROLE_TCS       | Stamford Hospital |
