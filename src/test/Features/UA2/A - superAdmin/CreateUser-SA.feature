Feature: Create User - Super Admin User
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with Partner Technical Administrator and verify Product Tiles and their redirections | Super Admin | Partner Technical Administrator | Episodes, Episodes 2.0, Reports, Physician Connect, Administration               |                                                           | ROLE_PRM       | Stamford Hospital |
