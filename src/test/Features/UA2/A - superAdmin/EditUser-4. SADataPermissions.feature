Feature: Edit data permissions for SA
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      |         20. | Super Admin | Remedy Other | test.automatemail | Butler Memorial Hospital | RWJ Barnabas Health, INC | all locations | all locations | BPCI-Model2, BPCI-CJR | BPCI-CJR         |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description | user        | Role      | Email             | Health System1 | Health System2  | Locations1    | Locations2    | ProgramsVisible1         | ProgramsVisible2         | Health System3                     | Programs3                | HasHealthSystem3 | Locations3    | ProgramsVisible3         |
      |         21. | Super Admin | Remedy RN | test.automatemail | TeamHealth     | Sound Physician | all locations | all locations | BPCI-Model2, BPCI-Model3 | BPCI-Model2, BPCI-Model3 | United Health Services of New York | BPCI-Model2, BPCI-Model3 | Yes              | all locations | BPCI-Model2, BPCI-Model3 |
  ...
  Scenario Outline: <Description>
    ...
    Then I click on Submit button for "<User>"
    And I wait for 5000 milli seconds
    Then I verify "<Health System1>::<ProgramsVisible>:<Locations1>; <Health System2>::<ProgramsVisible>:<Locations2>; <Health System3>::<ProgramsVisible>:<Locations3>" under Data Permissions in view user page

    Examples: 
      | Description | user        | Role      | Email             | Health System1 | Health System2  | Locations1                                                                 | Locations2                                                      | Health System3                     | HasHealthSystem3 | Locations3                                                           | ProgramsVisible         |  |
      |         22. | Super Admin | Remedy RN | test.automatemail | TeamHealth     | Sound Physician | 2070-g14--North Shore Med Center, 3056-q91--The Medical Center At Franklin | 6005-059--Evanston Hospital, 3056-b75--Warren Memorial Hospital | United Health Services of New York | Yes              | 6005-200--Cape Cod Hospital, 3090-209--Uhs Twin Tier Home Health Inc | BPCI-Model2, BPCI-Model3 |  |
