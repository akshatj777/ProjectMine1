Feature: Edit data permissions for SA
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Edit user from Model-2 to Model-3 and select single location    | Super Admin | Remedy TCS | test.automatemail | 3056-q91--The Medical Center At Franklin                                    | BPCI-Model2    | BPCI-Model3 |               |
      | Edit user from Model-2 to Model-3 and select multiple locations | Super Admin | Remedy TCS | test.automatemail | 3056-q91--The Medical Center At Franklin, 3056-q91--Rhea Medical Center     | BPCI-Model2    | BPCI-Model3 |               |
      | Edit user from Model-2 to Model-3 and select all locations      | Super Admin | Remedy TCS | test.automatemail | all locations                                                               | BPCI-Model2    | BPCI-Model3 |               |
      | Edit user from Model-3 to Model-2 and select single location    | Super Admin | Remedy TCS | test.automatemail | 2070-g14--North Shore Med Center                                            | BPCI-Model3    | BPCI-Model2 |               |
      | Edit user from Model-3 to Model-2 and select multiple locations | Super Admin | Remedy TCS | test.automatemail | 2070-g14--North Shore Med Center, 2070-g14--Baptist Medical Center  Beaches | BPCI-Model3    | BPCI-Model2 |               |
      | Edit user from Model-3 to Model-2 and select all locations      | Super Admin | Remedy TCS | test.automatemail | all locations                                                               | BPCI-Model3    | BPCI-Model2 |               |
