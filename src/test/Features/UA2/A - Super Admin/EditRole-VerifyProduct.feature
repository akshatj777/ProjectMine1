Feature: Edit page for superuser verification
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Edit role from Executive to Remedy Executive and verify Product list | Super Admin | test.automatemail | Executive |      | Reports, Lessons, Episodes, Episodes 2.0 |                             | Learning Pathway 2             | Stamford Hospital | Remedy Executive |      | TCI           | TCI                 | Reports, Lessons, Episodes, Episodes 2.0           |
      | Edit role from Manager to Remedy TCS and verify Product list         | Super Admin | test.automatemail | Manager   |      | Reports, Lessons, Episodes, Episodes 2.0 |                             | Learning Pathway 2             | Stamford Hospital | Remedy TCS       |      | TCI           | TCI                 | Reports, Lessons, Episodes, Episodes 2.0           |
      | Edit role from Physician to Manager and verify Product list          | Super Admin | test.automatemail | Physician | NPI  | Physician Connect                        | Physician Connect           | Learning Pathway 2             | Stamford Hospital | Manager          |      | Reports       | Report              | Lessons, Episodes, Episodes 2.0, Physician Connect |
