Feature: Edit user page for SA
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                          | user        | Role      | Email             | Health System    | Programs    | Locations                                        | Facilities                             | ProgramsValidation            | LocationsValidation                                                |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description  | user        | Role                            | Email             | Locations                        | Programs    | HasHealthSystem2 | Health System | Facilities             | ProgramsValidation      | LocationsValidation                          |
  ...
  Scenario Outline: Editing locations -<Description>
    ...
    Examples: 
      | Description                                              | user        | Role       | Email             | Locations                                                                     | Programs    | Health System | Facilities                                                                                                       | ProgramsValidation     | LocationsValidation                                                                                                                                              |
  ...
  Scenario Outline: Edit programs- <Description>
    ...
    Examples: 
      | Description                                                    | user        | Role                           | Email             | Locations                                      | RemovePrograms           | Programs    | Health System                                        | Facilities                           |
  ...
  Scenario Outline: Changing General information, Role from <PreviousRole> to <Role> and edit Data permissions
    ...
    Examples: 
      | User        | UserName                               | Password | FirstName       | LastName       | Email             | Phone        | NPI | PreviousRole              | Role              | EnableApplications | RemoveApplications | Applications | ApplicationsNotVisible            | Health System                      | RemovePrograms           | Programs    | Locations                                                     | LearningPathwaySearchParameter | Roletext | ReportCategory | ReportName         | BPID | Facilities                                | ProgramsValidation                              | LocationsValidation                                                                                                                   |
  ...
  Scenario Outline: Edit phone, Role from <PreviousRole> to <Role> and Remove Existing Location and Add new Location
    ...
    Examples: 
      | user        | PreviousRole | Role                           | NPI | EnableApplications                | Applications                                                                     | Email             | Health System                                        | Programs                 | DisableLocations                                                                         | EnableLocations                    | Locations                                                                                                                                                                                                                                | Roletext   | ReportCategory | ReportName         | BPID | Facilities                                                                                                                                                                   | ProgramsValidation                                                                                                           | LocationsValidation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
