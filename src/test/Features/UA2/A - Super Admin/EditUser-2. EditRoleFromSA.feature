Feature: Edit General information/Role/Permissions and validate
  ...
  Scenario Outline: Changing General information, Role from <PreviousRole> to <Role> and Data permissions
    ...
    Examples: 
      | User        | UserName                               | Password | FirstName       | LastName       | Email             | Phone        | NPI | PreviousRole                   | Role             | Applications                                                | ApplicationsNotVisible            |  Health System     | LearningPathwaySearchParameter |
      | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstNameEdited | LastNameEdited | test.automatemail | 996-385-2451 |     | Remedy Sales Team              | Remedy Executive | Episodes, Episodes 2.0, Reports, Lessons, TCI               | Administration, Physician Connect |  Stamford Hospital | Learning Pathway 2             |
      ...
      | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstNameEdited | LastNameEdited | test.automatemail | 996-385-2451 | NPI | Transitional Case Manager      | Physicians       | Episodes, Episodes 2.0, Reports, Lessons, Physician Connect | Administration                    |  Stamford Hospital | Learning Pathway 2             |
