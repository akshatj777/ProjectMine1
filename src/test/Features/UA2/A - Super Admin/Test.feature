Feature: Edit user page for SA
   ...
   Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with Super Admin User and create user with Partner Program Administrator role            | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstNameFirstNameFirstNameFirstNameFirst | LastName                                 | test.automatemail |            | Partner Program Administrator   | Episodes, Reports, Physician Connect, Lessons                                    | Episodes 2.0, Administration, TCI                                       |     | NFdw0Kts2C01, 3hSOHNAnvjc1, jusUV22erpk1, Physician Acute Care Hospital Model 2, Remedy University                                                                                                  | Brookdale                                                              | BPCI-Model3              | 3056-m55--Santa Rosa, 3056-m61--Carlsbad, 3056-m63--Carmel Valley, 3056-m69--Yorba Linda, 3056-m74--Palmer Ranch                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | No               |                                                      |                          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | No               |                                                      |                          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
#
  ...
  Scenario Outline: Editing user role from <PreviousRole> to <Role>
    ...
    Examples: 
      | User        | UserName                               | Password    | Email                 | NPI | PreviousRole | Role                          | EnableApplications | Applications                                  | ApplicationsNotVisible | LearningPathwaySearchParameter | Roletext | ReportCategory | ReportName                   | BPID |LearningPathway |
      | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1  | test.automatemail  |     | Manager      | Partner Program Administrator | Physician Connect  | Episodes, Reports, Physician Connect, Lessons | Administration, Episodes 2.0         |                                | ROLE_PRM | Patient ID     | Episode DRG Issues [Model 3] |      ||
  ...
  Scenario Outline: Changing the products and general details for <Role> and verifying product tile
    ...
    Examples: 
      | User        | Role               | Email              | DisableApplications | Applications               | ApplicationsNotVisible            | Roletext | ReportCategory | ReportName                   | BPID |LearningPathway |
      | Super Admin | Case Manager  | test.automatemail  | Reports             | Episodes                   | Administration, Physician Connect, Episodes 2.0 | ROLE_TCS | Patient ID     | Episode DRG Issues           |      ||
      | Super Admin | Remedy RN     | test.automatemail | Reports, Episodes   | Episodes 2.0, TCI, Lessons | Administration, Physician Connect | ROLE_RN  | Patient ID     | Episode DRG Issues [Model 3] |      ||
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                          | user        | Role      | Email             | Health System    | Programs    | Locations                                        | Facilities                             | ProgramsValidation            | LocationsValidation                                                |LearningPathway |
      | Remove Existing org and add new org1 | Super Admin | Executive | test.automatemail | Sound Physicians | BPCI-Model2 | 6005-080--Winchester Medical Center - Rehab Unit | Winchester Medical Center - Rehab Unit | Sound Physicians--BPCI-Model2 | Sound Physicians--6005-080--Winchester Medical Center - Rehab Unit ||
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description  | user        | Role                            | Email             | Locations                        | Programs    | HasHealthSystem2 | Health System | Facilities             | ProgramsValidation      | LocationsValidation                          |LearningPathway |
      | Add new org2 | Super Admin | Partner Technical Administrator | test.automatemail | 2070-g14--North Shore Med Center | BPCI-Model2 | Yes              | TeamHealth    | North Shore Med Center | TeamHealth--BPCI-Model2 | TeamHealth--2070-g14--North Shore Med Center ||
  ...
  Scenario Outline: Editing locations -<Description>
    ...
    Examples: 
      | Description                                              | user        | Role       | Email             | Locations                                                                     | Programs    | Health System | Facilities                                                                                                       | ProgramsValidation     | LocationsValidation                                                                                                                                              |LearningPathway |
      | External User-Edit single location to multiple locations | Super Admin | Remedy TCS | test.automatemail | 3056-m04--Altercare Post-acute Rehab Center, 3056-m05--Altercare - Big Rapids | BPCI-Model3 | Altercare     | Altercare Post-acute Rehab Center, Altercare - Big Rapids                                                        | Altercare--BPCI-Model3 | Altercare--3056-m04--Altercare Post-acute Rehab Center, Altercare--3056-m05--Altercare - Big Rapids                                                              ||
      | External User-Edit to All Locations                      | Super Admin | Remedy LPN | test.automatemail | all locations                                                                 | BPCI-Model2 | Penn          | Upenn - Hospital Of The Univ. Of Pennsylvania, Upenn - Penn Presbyterian Hospital, Upenn - Pennsylvania Hospital | Penn--BPCI-Model2      | Penn--2070-020--Upenn - Hospital Of The Univ. Of Pennsylvania, Penn--2070-021--Upenn - Penn Presbyterian Hospital, Penn--2070-022--Upenn - Pennsylvania Hospital ||
      | External User-Edit All locations to single location      | Super Admin | Remedy LPN | test.automatemail | 2070-020--Upenn - Hospital Of The Univ. Of Pennsylvania                       | BPCI-Model2 | Penn          | Upenn - Hospital Of The Univ. Of Pennsylvania                                                                    | Penn--BPCI-Model2      | Penn--2070-020--Upenn - Hospital Of The Univ. Of Pennsylvania                                                                                                    ||
  ...
  Scenario Outline: Edit programs- <Description>
    ...
    Examples: 
      | Description                                                    | user        | Role                           | Email             | Locations                                      | RemovePrograms           | Programs    | Health System                                        | Facilities                           |LearningPathway |
      | External user-Edit user to Model-2 and select single location  | Super Admin | Remedy Field RN                | test.automatemail | 2070-060--Carolinas Hospital System - Florence | BPCI-Model2, BPCI-Model3 | BPCI-Model2 | Cardiovascular Associates of The Delaware Valley,p A | Carolinas Hospital System - Florence ||
      | External user-Edit user to Model-3 and select single location  | Super Admin | Remedy Technical Administrator | test.automatemail | 3056-a08--Meritus Medical Center               | BPCI-Model3, BPCI-Model2 | BPCI-Model3 | Cardiovascular Associates of The Delaware Valley,p A | Meritus Medical Center               ||
      | External user-Edit user to BPCI-CJR and select single location | Super Admin | Remedy Executive               | test.automatemail | CJR-1--Butler Memorial Hospital                | BPCI-Model2, BPCI-CJR    | BPCI-CJR    | Butler Memorial Hospital                             | Butler Memorial Hospital             ||
