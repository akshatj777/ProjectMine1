Feature: Edit page for Downstream provider
  ...
  Scenario Outline: Changing Role from <PreviousRole> to <Role>
    ...
    Examples: 
      ...
      | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstNameEdited | LastNameEdited | test.automatemail | 996-385-2451 |     | Downstream Provider | Manager |Reports, Lessons |Episodes, Episodes 2.0, Reports, Lessons | Administration, Physician Connect | ROLE_PRM | Stamford Hospital | Learning Pathway 2             |
