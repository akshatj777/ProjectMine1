Feature: Anchor admission quarter filter on inpatient episode clearing report under patientid

Scenario Outline: Verify Anchor admission quarter filter under inpatient episode clearing reports under patientid
