Feature: Episode with DRG issue Patient ID
  ...
  Scenario Outline: Verify that Episode with DRG issue report display data based on provisioning
    ...
    Examples:
      | email                              | anchorFacility1                    | anchorFacility2               | Issue1           | Issue2       | Issue3         |
      | shutestaug231132a@yopmail.com      | Upenn - Penn Presbyterian Hospital | Upenn - Pennsylvania Hospital | MISMATCH OF DRGS | NO FINAL DRG | NO WORKING DRG |
      | shutestaug221130a@yopmail.com      | Upenn - Penn Presbyterian Hospital | Upenn - Pennsylvania Hospital | MISMATCH OF DRGS | NO FINAL DRG | NO WORKING DRG |
      | reptestachmodel2opsfin@yopmail.com | Upenn - Penn Presbyterian Hospital | Upenn - Pennsylvania Hospital | MISMATCH OF DRGS | NO FINAL DRG | NO WORKING DRG |
      | shutestaug15240p@yopmail.com       | Upenn - Penn Presbyterian Hospital | Upenn - Pennsylvania Hospital | MISMATCH OF DRGS | NO FINAL DRG | NO WORKING DRG |
      | shutestaug221145a@yopmail.com      | Upenn - Penn Presbyterian Hospital | Upenn - Pennsylvania Hospital | MISMATCH OF DRGS | NO FINAL DRG | NO WORKING DRG |
      | repopsnofintest@yopmail.com        | Upenn - Penn Presbyterian Hospital | Upenn - Pennsylvania Hospital | MISMATCH OF DRGS | NO FINAL DRG | NO WORKING DRG |