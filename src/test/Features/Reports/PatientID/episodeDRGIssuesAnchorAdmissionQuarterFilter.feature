Feature: Anchor admission quarter filter on episode drg issues report under patientid

Scenario Outline: Verify Anchor admission quarter filter under episode drg issues reports under patientid
