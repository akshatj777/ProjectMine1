Feature: Verification of filters under Readmissions Claims report under Post Acute Care for multiple payers

  Scenario Outline: Verification of participant,anchor facility,episode initiator,bpid and ccn filters under readmissions claims reports under readmissions
  ...
  Scenario Outline: User should be able to edit and delete the applied payer filter in readmissions claims report under readmissions
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
