Feature: Verification of filters under Performance Claims report under Overall program for multiple payers
  ...
  Scenario Outline: User should be able to edit and delete the applied payer filter in performance claims reports under overall program
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
