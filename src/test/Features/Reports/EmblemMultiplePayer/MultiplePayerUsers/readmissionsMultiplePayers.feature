Feature: Verification of filters under Readmissions report under Readmissions for multiple payers

  Scenario Outline: Verification of participant,anchor facility,episode initiator,bpid and ccn filters under readmissions reports
  ...
  Scenario Outline: User should be able to edit and delete the applied payer filter in carl report under next site of care
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
