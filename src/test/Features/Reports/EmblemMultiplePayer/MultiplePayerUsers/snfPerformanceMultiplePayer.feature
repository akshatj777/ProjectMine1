Feature: Verification of filters under SNF Performance Claims report under Post Acute Care for multiple payers

  Scenario Outline: Verification of participant,anchor facility,episode initiator,bpid and ccn filters under snf performance claims reports under post acute care
    ...
    Examples: 
      ...
      | multipayeachopsnofin@yopmail.com  | RP Payer Test A | Rp Test Hospital Two | Rp Test Hospital Two | 999999 | 7000-000 | Emblem Health | Medicare |          222222 |          441348 | 2070-020 | 2070-021 | 2070-022 | 390111 | 390223 | 390226 |
  ...
  Scenario Outline: User should be able to edit and delete the applied payer filter in snf performance claims reports under post acute care
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
