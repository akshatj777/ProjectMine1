Feature: Verification of filters under SNF Volume Claims report under Post Acute Care for Multiple payers

  Scenario Outline: Verification of participant,anchor facility,episode initiator,bpid and ccn filters under snf volume claims reports under post acute care
  ...
  Scenario Outline: User should be able to edit and delete the applied payer filter in snf volume claims reports under post acute care
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
