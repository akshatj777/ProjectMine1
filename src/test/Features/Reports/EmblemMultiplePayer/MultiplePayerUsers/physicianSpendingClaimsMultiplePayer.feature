Feature: Verification of filters under Spending Claims report under Physicain for multiple payer
  ...
  Scenario Outline: User should be able to edit and delete the applied payer filter in spending claims report under physician
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
