Feature: Verification of filters under Episode DRG Issues report under Patient ID for multiple payers

  Scenario Outline: Verification of participant,anchor facility,episode initiator,bpid and ccn filters under episode drg isssues reports
  ...
  Scenario Outline: User should be able to edit and delete the applied payer filter in episode drg issues report under patientid
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
