...
Scenario Outline: Remedy awardee convener whose BPID starting with 2070 with model2 is able to see fracture/non fracture values when anchor admission quarter >= 2016Q4 in volume claims report under physician
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
...
Scenario Outline: Remedy awardee convener whose BPID starting with 2070 with model2 is able to see only not-applicable in fracture/non fracture filters when anchor admission quarter is < 2016Q4 in volume claims report under physician
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
...
Scenario Outline: Non-Remedy awardee convener whose BPID not starting with 2070 with model2 should see only not-applicable in fracture/non fracture filters when anchor admission quarter is >= 2016Q4 in volume claims report under physician
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
...
Scenario Outline: User should see corresponding DRG when selected 469 drg code in the report in volume claims report under physician
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
...
Scenario Outline: User should see corresponding DRG when selected 470 drg code in the report in volume claims report under physician
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
...
Scenario Outline: User should not see patient risk and onboarding status level fields in the availble fields in volume claims report under physician
  ...
  Scenario Outline: fracture/non-fracture mapping in warehouse .dimDRG table should be 0,1,-99 in volume claims report under physician
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
  ...
  Scenario Outline: Fracture values should display 0 and 1 only when executed the below query for volume claims under physician
    Then User executes query
      """
  ...
  Scenario Outline: Fracture values should display -99 when executed the below query for volume claims under physician
    Then User executes query
      """
      select distinct (fracture)
      from reporting.episodeSummary where anchor_ms_drg in (469, 470) 
