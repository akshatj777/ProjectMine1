Feature: Episode avg days to drg patient id
  ...
  Scenario Outline: Verify that Episode avg days to drg report display data based on provisioning
    ...
    Examples:
      | email                         | participant | anchorFacility1                		  | anchorFacility2                  | episodeInitiator1              	  |BPID1				|
      | shutestaug231132a@yopmail.com | Penn        | Upenn - Penn Presbyterian Hospital  | Upenn - Pennsylvania Hospital		 | Penn Presbyterian Medical Center   | 2070-022 		|
