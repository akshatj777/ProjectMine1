Feature: Episode avg days to drg patient id
  ...
  Scenario Outline: Verify that Episode avg days to drg report display data based on provisioning
    ...
    Examples:
      | email                         | anchorFacility1                    | anchorFacility2               |  BPID1    | EpisodeStatus1 | EpisodeStatus1 | EpisodeStatus1 | EpisodeStatus1 | EpisodeStatus1 | Eligibility1 | Eligibility2 | Eligibility3 | Eligibility4 |
