Feature: Anchor admission quarter filter on SNF Performance report under Post Acute Care

Scenario Outline:  Verify Anchor admission quarter filter under SNF Performance reports under Post Acute Care
