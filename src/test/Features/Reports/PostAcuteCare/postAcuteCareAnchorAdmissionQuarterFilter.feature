Feature: Anchor admission quarter filter on Post Acute Care Claims report under Post Acute Care

Scenario Outline:  Verify Anchor admission quarter filter under Post Acuute Care Claims reports under Post Acute Care
    ...
    Examples:
      ...
      | shutestaug15240p@yopmail.com       | 2016Q4                    |
