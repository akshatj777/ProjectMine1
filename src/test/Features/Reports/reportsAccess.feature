Feature: User only see reports per report tiles based on their role (external and internal roles),facility and model
  ...
  Scenario Outline: For RPFIN, RPNOFIN verify the respective reports link as per the user permissions
  ...
  Scenario Outline: For OPSFIN verify the respective reports link as per the user permissions
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
    ...
    Examples:
      ...
      | shutestaug221140a@yopmail.com | Dashboards | Overall Program | Patient ID | Post Acute Care | NSoC   | Readmissions |


  Scenario Outline: For OPSSPEND verify the respective reports link as per the user permissions
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
  ...
  Scenario Outline: For OPSNOFIN verify the respective reports link as per the user permissions
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
  ...
  Scenario Outline: For ECReports verify the respective reports link as per the user permissions
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
