Feature: Accepatance testing for reports
  ...
  Scenario Outline: User should be able to verify the business functionalities of adj hostoric values in <Module> <Report> report after filtering drg codes 469 and 470 and make sure there are NON-Null,Non-zero,Non-N/A in the report page
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
    ...
    And I choose "Filter" option from select options of filter field
    And I should see "DRG Code" in the header text of filter page
    And I should see "469" in the filter value list
    And I should see "470" in the filter value list
    And I click on "469" in the filter value list
    And I click on add selected in the filter model
    And I click on "470" in the filter value list
    And I click on add selected in the filter model
    And I click on ok button from filter
    And I wait until refresh button is disappeared
    Then I verify "DRG Code includes 469 and 470" is appearing under selected drgcode filter
    #% Disch to Home (Adj Hist)
    Then I remove the field "% Disch to Home (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "% Disch to Home (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "% Disch to Home (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "% Disch to Home (Adj Hist)"
    #% Disch to HHA (Adj Hist)
    Then I remove the field "% Disch to HHA (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "% Disch to HHA (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "% Disch to HHA (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "% Disch to HHA (Adj Hist)"
    #% Disch to SNF (Adj Hist)
    Then I remove the field "% Disch to SNF (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "% Disch to SNF (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "% Disch to SNF (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "% Disch to SNF (Adj Hist)"
    #% Disch to IRF (Adj Hist)
    Then I remove the field "% Disch to IRF (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "% Disch to IRF (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "% Disch to IRF (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "% Disch to IRF (Adj Hist)"
    #% Disch to LTCH (Adj Hist)
    Then I remove the field "% Disch to LTCH (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "% Disch to LTCH (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "% Disch to LTCH (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "% Disch to LTCH (Adj Hist)"
    #% Disch to Other (Adj Hist)
    Then I remove the field "% Disch to Other (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "% Disch to Other (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "% Disch to Other (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "% Disch to Other (Adj Hist)"
    #% Eps w Readmit (Adj Hist)
    Then I remove the field "% Eps w Readmit (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "% Eps w Readmit (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "% Eps w Readmit (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "% Eps w Readmit (Adj Hist)"
    #Readmit per Eps (Adj Hist)
    Then I remove the field "Readmit per Eps (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to " Readmit per Eps (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field " Readmit per Eps (Adj Hist)"
    Then I verify "Null" is not appearing in the added field " Readmit per Eps (Adj Hist)"
    #SNF Days (Adj Hist)
    Then I remove the field "SNF Days (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "SNF Days (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "SNF Days (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "SNF Days (Adj Hist)"
  ...
  Scenario Outline: User should be able to verify the business functionalities of adj hostoric values in spending category report after filtering drg codes 469 and 470 and make sure there are NON-Null,Non-zero,Non-N/A in the report page
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
    ...
    And I wait until refresh button is disappeared
    Then I verify "DRG Code includes 469 and 470" is appearing under selected drgcode filter
    #(Adj Hist) Spending Avg
    Then I remove the field "(Adj Hist) Spending Avg" from the report column
    And I wait until refresh button is disappeared
    When I click to "(Adj Hist) Spending Avg" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "(Adj Hist) Spending Avg"
    Then I verify "Null" is not appearing in the added field "(Adj Hist) Spending Avg"
  ...
  Scenario Outline: User should be able to verify the business functionalities of adj hostoric values under post acute care snf performance report after filtering drg codes 469 and 470 and make sure there are NON-Null,Non-zero,Non-N/A in the report page
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
    ...
    Then I verify "Null" is not appearing in the added field "%Eps w Readmit (Adj. Hist)"
    #Readmit per Eps (Adj Hist)
    Then I remove the field "Readmits per Eps (Adj. Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to " Readmit per Eps (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "Readmits per Eps (Adj. Hist)"
    Then I verify "Null" is not appearing in the added field "Readmits per Eps (Adj. Hist)"
    #SNF Days (Adj Hist)
    Then I remove the field "SNF Days (Adj. Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "SNF Days (Adj Hist)" field filter under "Measures" filter field
  ...
  Scenario Outline: User should be able to verify the business functionalities of adj hostoric values in <Module> <Report> report after filtering drg codes 469 and 470 and make sure there are NON-Null,Non-zero,Non-N/A in the report page
    ...
    Then I verify "N/A" is not appearing in the added field "SNF Days (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "SNF Days (Adj Hist)"
    #Leaked Readmit per Eps (Adj Hist)
    Then I remove the field "Leaked Readmit per Eps (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "Leaked Readmit per Eps (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "Leaked Readmit per Eps (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "Leaked Readmit per Eps (Adj Hist)"
    #Diff Bundle Readmit per Eps (Adj Hist)
    Then I remove the field "Diff Bundle Readmit per Eps (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "Diff Bundle Readmit per Eps (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "Diff Bundle Readmit per Eps (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "Diff Bundle Readmit per Eps (Adj Hist)"
    #HOME Eps w Readmit (Adj Hist)
    Then I remove the field "HOME Eps w Readmit (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "HOME Eps w Readmit (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "HOME Eps w Readmit (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "HOME Eps w Readmit (Adj Hist)"
    #HHA Eps w Readmit (Adj Hist)
    Then I remove the field "HHA Eps w Readmit (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "HHA Eps w Readmit (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "HHA Eps w Readmit (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "HHA Eps w Readmit (Adj Hist)"
    #SNF Eps w Readmit (Adj Hist)
    Then I remove the field "SNF Eps w Readmit (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "SNF Eps w Readmit (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "SNF Eps w Readmit (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "SNF Eps w Readmit (Adj Hist)"
    #IRF Eps w Readmit (Adj Hist)
    Then I remove the field "IRF Eps w Readmit (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "IRF Eps w Readmit (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "IRF Eps w Readmit (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "IRF Eps w Readmit (Adj Hist)"
    #Other Eps w Readmit (Adj Hist)
    Then I remove the field "Other Eps w Readmit (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "Other Eps w Readmit (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "Other Eps w Readmit (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "Other Eps w Readmit (Adj Hist)"
    #% Eps w Readmit w/in 7 days (Adj Hist)
    Then I remove the field "% Eps w Readmit w/in 7 days (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "% Eps w Readmit w/in 7 days (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "% Eps w Readmit w/in 7 days (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "% Eps w Readmit w/in 7 days (Adj Hist)"
    #% Eps w Readmit w/in 15 days (Adj Hist)
    Then I remove the field "% Eps w Readmit w/in 15 days (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "% Eps w Readmit w/in 15 days (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "% Eps w Readmit w/in 15 days (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "% Eps w Readmit w/in 15 days (Adj Hist)"
    #% Eps w Readmit w/in 30 days (Adj Hist)
    Then I remove the field "% Eps w Readmit w/in 30 days (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "% Eps w Readmit w/in 30 days (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "% Eps w Readmit w/in 30 days (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "% Eps w Readmit w/in 30 days (Adj Hist)"
    #% Eps w Readmit w/in 60 days (Adj Hist)
    Then I remove the field "% Eps w Readmit w/in 60 days (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "% Eps w Readmit w/in 60 days (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "% Eps w Readmit w/in 60 days (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "% Eps w Readmit w/in 60 days (Adj Hist)"
    #% Eps w Readmit w/in 90 days (Adj Hist)
    Then I remove the field "% Eps w Readmit w/in 90 days (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "% Eps w Readmit w/in 90 days (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "% Eps w Readmit w/in 90 days (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "% Eps w Readmit w/in 90 days (Adj Hist)"
    #LTCH Eps w Readmit (Adj Hist)
    Then I remove the field "LTCH Eps w Readmit (Adj Hist)" from the report column
    And I wait until refresh button is disappeared
    When I click to "LTCH Eps w Readmit (Adj Hist)" field filter under "Measures" filter field
    And I choose add to report option from select options of filter field
    And I wait until refresh button is disappeared
    Then I verify "N/A" is not appearing in the added field "LTCH Eps w Readmit (Adj Hist)"
    Then I verify "Null" is not appearing in the added field "LTCH Eps w Readmit (Adj Hist)"
