Feature: Verification of filters under Episode DRG Issues report

  Scenario Outline: Verification of participant,anchor facility,episode initiator,bpid and ccn filters under episode drg issue report
