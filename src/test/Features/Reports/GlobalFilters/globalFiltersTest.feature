...
Scenario Outline: User should see multiple filters selected in report should redirect in other reports when selected more than 3 filters
    ...
    And I should see "Episode Initiator: Hospital of The University of Pennsylvania" under applied filter of global filters
    Then I click on <anchor facility2> checkbox under participant for global filters
    And I should see "Anchor Facility: Upenn - Hospital Of The Univ. Of Pennsylvania" under applied filter of global filters
...
Scenario Outline: User should remove the selected global filter using X mark and that should be reflected in other reports
    ...
    When I switch to default window from iframe
    Then I click on Show Summary button to unhide the available global filters
    When I click on cross mark beside the selected participant filter with <participantid1>
    ...
    When I switch to default window from iframe
    Then I click on Show Summary button to unhide the available global filters
    When I click on cross mark beside the selected episode initiator filter with <episode initiator3>
    ...
    When I switch to default window from iframe
    Then I click on Show Summary button to unhide the available global filters
    When I click on cross mark beside the selected anchor facility filter with <anchor facility2>
