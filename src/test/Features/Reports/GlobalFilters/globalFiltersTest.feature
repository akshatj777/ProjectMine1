...
Scenario Outline: User should remove the selected global filter using X mark and that should be reflected in other reports
    ...
    Examples:
       ...
       | email                        | Menu 1      | participant1 | episode initiator1                                                        | anchor facility1                | participantid1 | payer1   | payerid |
       | shutestaug231132a@yopmail.com| Dashboards  | Penn         | The Pennsylvania Hospital of The University of Pennsylvania Health System | Hospital Of Univ Of Pennsylvania| 441348         | Medicare | 100001  |
...
Scenario Outline: User should clear the selected filters in global filters
    ...
    Examples:
      ...
      | email                         | Menu 1     | participant1 | episode initiator1                                                        | anchor facility1                | participantid1 | payer1   |
      | shutestaug231132a@yopmail.com | Dashboards | Penn         | The Pennsylvania Hospital of The University of Pennsylvania Health System | Hospital Of Univ Of Pennsylvania| 441348         | Medicare |
