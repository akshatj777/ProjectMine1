...
Scenario Outline: User should be able to see the Global Filters
    ...
    Examples:
      ...
      | email                         | Menu 1     | participant1 | episode initiator1               | anchor facility1                 | participantid1 | bpid1    | ccn1   | payer1   | payerid |
      | shutestaug231132a@yopmail.com | Dashboards | Penn         | Penn Presbyterian Medical Center | Penn Presbyterian Medical Center | 441348         | 2070-021 | 390223 | Medicare | 100001  |
