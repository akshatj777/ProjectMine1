...
Scenario Outline: For PGP MODEL 3 RPFIN, RPNOFIN reports link verification for the respective reports links functionality
 ...
 Scenario Outline: For PGP MODEL 3 OPSFIN reports link verification for the respective reports links functionality
 ...
 Scenario Outline: For PGP MODEL 3 OPSNOFIN reports link verification for the respective reports links functionality
