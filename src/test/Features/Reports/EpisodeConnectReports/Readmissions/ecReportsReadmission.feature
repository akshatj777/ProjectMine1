Feature: Verification of Readmissions EC report
  ...
  Scenario Outline: Verify the potential values in onboarding status are 0,1,2,3 in readmissions report under readmissions
    Then User executes query
      """
  ...
  Scenario Outline: Verify the potential values in onboarding status contains null in readmissions report under readmissions
    Then User executes query
      """
