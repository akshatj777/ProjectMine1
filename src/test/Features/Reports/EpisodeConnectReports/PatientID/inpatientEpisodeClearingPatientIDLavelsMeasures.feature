Feature: Inpatient Episode Clearing Levels,Measures and Remove Default Filters
  ...
  Scenario Outline: Verification of inpatient episode clearing report with pgp model3 users
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
  ...
  Scenario Outline: Verify globalfilters in Inpatient Episode Clearing report for model3 pgp users
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
  ...
  Scenario Outline: User should be able to verify anchor post acute fields for Model3 users in inpatient episode clearing report
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
  ...
  Scenario Outline: User should be able to verify anchor post acute fields other than Model3 users in inpatient episode clearing report
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field Testing1 for Login
    Then I click Access button
