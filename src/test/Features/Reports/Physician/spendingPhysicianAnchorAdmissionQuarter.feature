Feature: Anchor admission quarter filter on Spending Claims report under Physician

Scenario Outline: Verify Anchor admission quarter filter under Spending Claims reports under Physician
