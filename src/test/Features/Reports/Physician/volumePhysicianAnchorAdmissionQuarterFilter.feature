Feature: Anchor admission quarter filter on Volume Claims report under Physician

Scenario Outline: Verify Anchor admission quarter filter under Volume Claims reports under Physician
