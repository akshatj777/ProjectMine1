Feature: Anchor admission quarter filter on Performance Claims report under Physician

Scenario Outline: Verify Anchor admission quarter filter under Performace Claims reports under Physician
