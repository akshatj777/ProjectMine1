Feature: Anchor admission quarter filter on Readmissions Claims report under Readmissions

Scenario Outline: Verify Anchor admission quarter filter under readmissions claims reports under Readmissions
