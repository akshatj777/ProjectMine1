Feature: Anchor admission quarter filter on financial performance claims report under overall program

Scenario Outline: Verify Anchor admission quarter filter under financial performance claims reports under overall program
