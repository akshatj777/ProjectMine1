Feature: Anchor admission quarter filter on performance claims report under overall program

Scenario Outline: Verify Anchor admission quarter filter under performance claims reports under overall program
