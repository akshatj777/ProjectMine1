Feature: Anchor admission quarter filter on NSOC Summary report under Next Site of Care

Scenario Outline: Verify Anchor admission quarter filter under NSOC Summary reports under Next Site of Care
