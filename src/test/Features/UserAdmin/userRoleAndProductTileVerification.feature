Feature: Verification of corresponding Product tile as per user role
  ...
  | Downstream Provider             | DP                    | Downstream Provider            | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 |          |         |         | Episodes 2.0 | Institute |                              |                |                |                  | Support  |
 
  Scenario Outline: Super Admin create User with few product tiles and verifies the Product tiles as per selected user role
    Given I am on the login page
    When I log in as super user
    And I wait for 1000 milli seconds
    Then I should see Tile text User Admin
    ...
    And I should see Log in widget
    Examples: 
      | Role                            | Email | lastName                        | HealthSystem Search | Health System     | Provider | Phone        | payer    | NPI        | Password | Label1            | Label2            | Episode1 | RemedyU | Reports | Episode2     | Institute | Physican connect             | Administration | userroletext   | Internal Support | Support |
      | Remedy Technical Administrator  | RTA   | Remedy Technical Administrator  | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | episode_connect   | physician_portal  | Episodes |         |         |              | Institute | Gainsharing Physician Survey |                | ROLE_ADMIN     |                  | Support |
      | Executive                       | EXE   | Executive                       | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | episode_connect   | episode_connect_2 | Episodes |         |         | Episodes 2.0 | Institute |                              |                | ROLE_PRM       |                  | Support |
      | Manager                         | MNGR  | Manager                         | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | reports           | episode_connect_2 |          |         | Reports | Episodes 2.0 | Institute |                              |                | ROLE_PRM       |                  | Support |
      | Case Manager                    | CMNGR | Case Manager                    | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | reports           | episode_connect_2 |          |         | Reports | Episodes 2.0 | Institute |                              |                | ROLE_TCS       |                  | Support |
      | Physicians                      | PHY   | Physicians                      | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare | 1234567890 | Testing1 | reports           | episode_connect_2 |          |         | Reports | Episodes 2.0 | Institute |                              |                | ROLE_CLINICIAN |                  | Support |
      | Remedy TCS                      | RTCS  | Remedy TCS                      | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | internal_support  | lessons           |          | RemedyU |         |              | Institute |                              |                | ROLE_TCS       | Internal Support |         |
      | Remedy LPN                      | RLPN  | Remedy LPN                      | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | internal_support  | lessons           |          | RemedyU |         |              | Institute |                              |                | ROLE_LPN       | Internal Support |         |
      | Remedy RN                       | RRN   | Remedy RN                       | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | internal_support  | lessons           |          | RemedyU |         |              | Institute |                              |                | ROLE_RN        | Internal Support |         |
      | Remedy Field RN                 | RFRN  | Remedy Field RN                 | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | tci               | episode_connect   | Episodes |         |         |              | Institute |                              |                | ROLE_FRN       |                  | Support |
      | Remedy PM                       | RPM   | Remedy PM                       | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | tci               | episode_connect   | Episodes |         |         |              | Institute |                              |                | ROLE_PM        |                  | Support |
      | Remedy Sales Team               | RST   | Remedy Sales Team               | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | reports           | tci               |          |         | Reports |              | Institute |                              |                |                |                  |         |
      | Remedy Executive                | REXE  | Remedy Executive                | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | episode_connect   | episode_connect_2 | Episodes |         |         | Episodes 2.0 | Institute |                              |                | ROLE_PM        |                  | Support |
      ...
      | Remedy Other                    | RO    | Remedy Other                    | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | episode_connect_2 | tci               |          |         |         | Episodes 2.0 | Institute |                              |                | ROLE_PRM       |                  | Support |
      | Partner Program Administrator   | PPA   | Partner Program Administrator   | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | physician_portal  | internal_support  |          |         |         |              | Institute | Gainsharing Physician Survey |                | ROLE_PRM       | Internal Support |         |
      | Remedy Program Administrator    | RPA   | Remedy Program Administrator    | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | physician_portal  | internal_support  |          |         |         |              | Institute | Gainsharing Physician Survey |                | ROLE_PRM       | Internal Support |         |
      | Partner Technical Administrator | PTA   | Partner Technical Administrator | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | episode_connect   | reports           | Episodes |         | Reports |              | Institute |                              |                | ROLE_PM        |                  | Support |
      | Transitional Case Manager       | TCM   | Transitional Case Manager       | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 | episode_connect   | reports           | Episodes |         | Reports |              | Institute |                              |                | ROLE_TCS       |                  | Support |
      | Downstream Provider             | DP    | Downstream Provider             | Stamford            | Stamford Hospital | *        | 302-459-1143 | Medicare |            | Testing1 |                   | episode_connect_2 |          |         |         | Episodes 2.0 | Institute |                              |                |                |                  | Support |
