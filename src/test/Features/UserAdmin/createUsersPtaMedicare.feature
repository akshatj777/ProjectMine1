Feature: Create new User role with Partner Technical Admin with medicare payer and verify Login logout of user

Scenario Outline: Partner Technical Administrator can create user and verify login and navigation of different tiles and logout of created user
   ...
   Scenario Outline: Partner Technical Administrator can create user role with TCM and verify login and different product tiles navigation and logout of created user
    Given I am on the login page
    When I enter email field PTAUSER@mailinator.com for login
    And I wait for 1000 milli seconds
    Then I should see Tile text User Admin
