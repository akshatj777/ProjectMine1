Feature: Create new User for multiple payers and product tiles verification on create user page and navigation to different product tiles after created users login
  ...
  Scenario Outline: Super Admin can create all user with multiple payers and verify product tiles as per user role assigned after login and navigation to product tiles
    ...
    Examples: 
      ...
      | Downstream Provider             | Downstream Provider             |                       |                 | *         | 302-459-1143 |               |            |          |         |         | Episodes 2.0 | Institute |                              |                |                |                  | Support | Stamford              | Stamford Hospital | *         | Medicare |
  ...
  Scenario Outline: Super Admin create user different health system provider and few product tiles and verification of tiles on user login and navigation of different tiles
    ...
    Examples: 
      ...
      | Remedy Technical Administrator  | Remedy Technical Administrator  | RP Payer Test A       | RP Payer Test A | 7000-000  | Rp Test Hospital2 | 302-459-1143 | Emblem Health |            | episode_connect   | physician_portal  | Episodes |         |         |              | Institute | Gainsharing Physician Survey |                | ROLE_ADMIN     |                  | Support | Trinity                  | Trinity                  | 2070-c83  | Holy Cross Rehabilitation Institute  | Medicare |
      | Executive                       | Executive                       | RP Payer Test A       | RP Payer Test A | 7000-000  | Rp Test Hospital2 | 302-459-1143 | Emblem Health |            | episode_connect   | episode_connect_2 | Episodes |         |         | Episodes 2.0 | Institute |                              |                | ROLE_PRM       |                  | Support | Stamford                 | Stamford Hospital        | 2070-015  | Stamford Hospital                    | Medicare |
      ...
      | Case Manager                    | Case Manager                    | RP Payer Test A       | RP Payer Test A | *         |                   | 302-459-1143 | Emblem Health |            | reports           | episode_connect_2 |          |         | Reports | Episodes 2.0 | Institute |                              |                | ROLE_TCS       |                  | Support | St. Lukes Health Network | St. Lukes Health Network | 2070-023  | Allentown                            | Medicare |
      | Physicians                      | Physicians                      | RP Payer Test A       | RP Payer Test A | 7000-000  | Rp Test Hospital2 | 302-459-1143 | Emblem Health | 1234567890 | reports           | episode_connect_2 |          |         | Reports | Episodes 2.0 | Institute |                              |                | ROLE_CLINICIAN |                  | Support | Stamford                 | Stamford Hospital        | 2070-015  | Stamford Hospital                    | Medicare |
      | Remedy TCS                      | Remedy TCS                      | RP Payer Test A       | RP Payer Test A | 7000-000  | Rp Test Hospital2 | 302-459-1143 | Emblem Health |            | internal_support  | lessons           |          | RemedyU |         |              | Institute |                              |                | ROLE_TCS       | Internal Support |         | St. Lukes Health Network | St. Lukes Health Network | 2070-023  | Allentown                            | Medicare |
      ...
      | Remedy RN                       | Remedy RN                       | RP Payer Test A       | RP Payer Test A | 7000-000  | Rp Test Hospital2 | 302-459-1143 | Emblem Health |            | internal_support  | lessons           |          | RemedyU |         |              | Institute |                              |                | ROLE_RN        | Internal Support |         | Hackensack               | Hackensack               | 2070-005  | Hackensack University Medical Center | Medicare |
      | Remedy Field RN                 | Remedy Field RN                 | RP Payer Test A       | RP Payer Test A | *         |                   | 302-459-1143 | Emblem Health |            | tci               | episode_connect   | Episodes |         |         |              | Institute |                              |                | ROLE_FRN       |                  | Support | St. Lukes Health Network | St. Lukes Health Network | 2070-023  | Allentown                            | Medicare |
      | Remedy PM                       | Remedy PM                       | RP Payer Test A       | RP Payer Test A | 7000-000  | Rp Test Hospital2 | 302-459-1143 | Emblem Health |            | tci               | episode_connect   | Episodes |         |         |              | Institute |                              |                | ROLE_PM        |                  | Support | Sound                    | Sound Physician          | 6005-196  | Samaritan Hospital                   | Medicare |
      ...
      | Remedy Executive                | Remedy Executive                | RP Payer Test A       | RP Payer Test A | 7000-000  | Rp Test Hospital2 | 302-459-1143 | Emblem Health |            | episode_connect   | episode_connect_2 | Episodes |         |         | Episodes 2.0 | Institute |                              |                | ROLE_PM        |                  | Support | Stamford                 | Stamford Hospital        | 2070-015  | Stamford Hospital                    | Medicare |
      ...
      | Remedy Other                    | Remedy Other                    | RP Payer Test A       | RP Payer Test A | *         |                   | 302-459-1143 | Emblem Health |            | episode_connect_2 | tci               |          |         |         | Episodes 2.0 | Institute |                              |                | ROLE_PRM       |                  | Support | St. Lukes Health Network | St. Lukes Health Network | 2070-023  | Allentown                            | Medicare |
      | Partner Program Administrator   | Partner Program Administrator   | RP Payer Test A       | RP Payer Test A | 7000-000  | Rp Test Hospital2 | 302-459-1143 | Emblem Health |            | physician_portal  | internal_support  |          |         |         |              | Institute | Gainsharing Physician Survey |                | ROLE_PRM       | Internal Support |         | Sound                    | Sound Physician          | 6005-196  | Samaritan Hospital                   | Medicare |
