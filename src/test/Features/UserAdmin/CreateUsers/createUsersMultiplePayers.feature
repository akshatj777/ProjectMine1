Feature: Create new User for multiple payers and product tiles verification on create user page and navigation to different product tiles after created users login
  ...
  Scenario Outline: Super Admin create user different health system provider and few product tiles and verification of tiles on user login and navigation of different tiles
    ...
    Examples: 
      ...
      | Remedy PM                       | Remedy PM                       | RP Payer Test A       | RP Payer Test A | 7000-000  | Rp Test Hospital2 (999999) | 302-459-1143 | Emblem Health |            | tci               | episode_connect   | Episodes |         |         |              | Institute |                              |                | ROLE_PM        |                  | Support | Sound                    | Sound Physician          | 6005-196  | Samaritan Hospital (.)                           | Medicare |
      ...
      | Partner Program Administrator   | Partner Program Administrator   | RP Payer Test A       | RP Payer Test A | 7000-000  | Rp Test Hospital2 (999999) | 302-459-1143 | Emblem Health |            | physician_portal  | internal_support  |          |         |         |              | Institute | Gainsharing Physician Survey |                | ROLE_PRM       | Internal Support |         | Sound                    | Sound Physician          | 6005-196  | Samaritan Hospital (.)                           | Medicare |
