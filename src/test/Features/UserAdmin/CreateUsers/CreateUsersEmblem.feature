Feature: Creation of User with Emblem Payer and product tiles verification on create user page and navigation of product tiles after create user Login
  ...
  Scenario Outline: Super Admin create user different health system provider and few product tiles and verification of tiles on user login and navigation of different tiles
    ...
    Examples: 
      ...
      | Remedy Technical Administrator  | Remedy Technical Administrator  | RP Payer Test A     | RP Payer Test A | 7000-000 | Rp Test Hospital2 (999999) | 302-459-1143 | Emblem Health |            | episode_connect   | physician_portal  | Episodes |         |         |              | Institute | Gainsharing Physician Survey |                | ROLE_ADMIN     |                  | Support |
      | Executive                       | Executive                       | RP Payer Test A     | RP Payer Test A | 7000-000 | Rp Test Hospital2 (999999) | 302-459-1143 | Emblem Health |            | episode_connect   | episode_connect_2 | Episodes |         |         | Episodes 2.0 | Institute |                              |                | ROLE_PRM       |                  | Support |
      ...
      | Physicians                      | Physicians                      | RP Payer Test A     | RP Payer Test A | 7000-000 | Rp Test Hospital2 (999999) | 302-459-1143 | Emblem Health | 1234567890 | reports           | episode_connect_2 |          |         | Reports | Episodes 2.0 | Institute |                              |                | ROLE_CLINICIAN |                  | Support |
      | Remedy TCS                      | Remedy TCS                      | RP Payer Test A     | RP Payer Test A | 7000-000 | Rp Test Hospital2 (999999) | 302-459-1143 | Emblem Health |            | internal_support  | lessons           |          | RemedyU |         |              | Institute |                              |                | ROLE_TCS       | Internal Support |         |
      ...
      | Remedy RN                       | Remedy RN                       | RP Payer Test A     | RP Payer Test A | 7000-000 | Rp Test Hospital2 (999999) | 302-459-1143 | Emblem Health |            | internal_support  | lessons           |          | RemedyU |         |              | Institute |                              |                | ROLE_RN        | Internal Support |         |
      ...
      | Remedy PM                       | Remedy PM                       | RP Payer Test A     | RP Payer Test A | 7000-000 | Rp Test Hospital2 (999999) | 302-459-1143 | Emblem Health |            | tci               | episode_connect   | Episodes |         |         |              | Institute |                              |                | ROLE_PM        |                  | Support |
      ...
      | Remedy Executive                | Remedy Executive                | RP Payer Test A     | RP Payer Test A | 7000-000 | Rp Test Hospital2 (999999) | 302-459-1143 | Emblem Health |            | episode_connect   | episode_connect_2 | Episodes |         |         | Episodes 2.0 | Institute |                              |                | ROLE_PM        |                  | Support |
      ...
      | Partner Program Administrator   | Partner Program Administrator   | RP Payer Test A     | RP Payer Test A | 7000-000 | Rp Test Hospital2 (999999) | 302-459-1143 | Emblem Health |            | physician_portal  | internal_support  |          |         |         |              | Institute | Gainsharing Physician Survey |                | ROLE_PRM       | Internal Support |         |
      ...
      | Partner Technical Administrator | Partner Technical Administrator | RP Payer Test A     | RP Payer Test A | 7000-000 | Rp Test Hospital2 (999999) | 302-459-1143 | Emblem Health |            | episode_connect   | reports           | Episodes |         | Reports |              | Institute |                              |                | ROLE_PM        |                  | Support |
