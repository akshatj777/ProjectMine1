Feature: Create new User and verify Login logut of user
  ...
  Scenario Outline: Super Administrator can create user role Remedy Sales Team and TCM and verify login and navigation of internal support and reset password logout of created user
