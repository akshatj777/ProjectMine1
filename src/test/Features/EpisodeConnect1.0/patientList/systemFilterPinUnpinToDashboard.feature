Feature: Episode Connect patient list
  ...
  Scenario Outline: User can navigate to episode connect dashboard and pin/unpin system filters to dashboard
    ...
    Then I click on Pin to dashboard in "Inpatient Episodes" to pin the filter to dashboard
    And I wait for 7000 milli seconds
    Then I click on Unpin from dashboard in "Inpatient Episodes" to unpin the filter from dashboard
