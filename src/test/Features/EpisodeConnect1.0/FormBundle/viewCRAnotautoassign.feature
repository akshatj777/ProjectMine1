...
Feature: CRA Not Auto-assignment
  ...
  Scenario: CRA should not be assigned automatically if other CRA exists in assigned.
    ...
    Then I verify "Clinical Risk Assessment assigned" not in "Assigned Form list" "2"
