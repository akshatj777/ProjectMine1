Feature: As an EMBLEM associated provider I would like to complete the CARL form for my patients
  ...
  Scenario Outline: Verify complete CARL button with active episode M2 in anchor admission HHH_Inpatient+Scheduled active episode, admit is in the past without discharge , today
    Given I am on the login page
    When I enter email field qa.emblemrn@yopmail.com for login
    And I enter password field Episode1! for Login
    Then I click Access button
  ...
  Scenario Outline: Verify complete CARL button with active episode M2 in anchor admission HHH_Inpatient+Scheduled active episode, admit is in the future without discharge
    Given I am on the login page
    When I enter email field qa.emblemrn@yopmail.com for login
    And I enter password field Episode1! for Login
    Then I click Access button
