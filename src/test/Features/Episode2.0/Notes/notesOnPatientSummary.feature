...
<<<<<<< HEAD:src/test/Features/Episode2.0/Notes/NotesonPatientSummary.feature
  ...
  Scenario: To Verify Quick Action has the following criteria on Patient Summary
             Topic drop down, Activity Date drop down calendar, Body text box, Attach files link,
             Create note link, Cancel link
...
And I verify Cancel button appears on the Add Clinical Document on Note Creation
And I verify Create note appears on the Add Clinical Document on Note Creation
>>>>>>> develop:src/test/Features/Episode2.0/Notes/notesOnPatientSummary.feature
