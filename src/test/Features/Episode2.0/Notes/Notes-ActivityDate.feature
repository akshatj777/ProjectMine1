...
Scenario: Verify that user should be able to select any valid date from the Notes - Activity Date through calendar.
...
Scenario: Verify that user should be able to create any date(past/present/future) as Notes - Activity Date.
