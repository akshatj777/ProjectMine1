Feature: Model 2 Readmission
  ...
  Then I click on datepicker button to select the admit date on add a new transition
  Then I click on the centre of the calendar header to select date and month on Transition Page
  Then I click on the previous next link to select the required year "11" on date picker
  Then I select the month "11" from calendar from date picker
  Then I select the "11" from the calendar from date picker on Transition Page
  Then I select the "11" time from the calendar from date picker on Transition Page
  ...
  Scenario Outline: Patient  episode having readmission to an ACH facility as HHH-I with NON BPCI DRG
  Given I am on the login page
  When I enter email field <email> for login
  And I enter password field <password> for Login
  Then I click Access button
  ...
  Then I select the "3" DRG on the Diagnosis and DRG tab on add a new transition
  ...
  Scenario Outline: Patient with Active having readmission to an ACH facility as HHH-I with BPCI DRG
    Given I am on the login page
    When I enter email field <email> for login
    And I enter password field <password> for Login
    Then I click Access button
