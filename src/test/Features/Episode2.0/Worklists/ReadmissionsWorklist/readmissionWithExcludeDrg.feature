Feature: Active Episode HHH-Inpatient/Scheduled with DRG 472 W Readmitted to HHH-I/S with DRG 239
  ...
  Scenario Outline: Active Episode HHH-Inpatient/Scheduled with DRG 472 W Readmitted to HHH-I/S with DRG 239
    ...
    Then I should see Tile text Episode
    ...
    Then I select the "472" DRG on the Diagnosis and DRG tab on add a new transition
    Then I wait for 5000 milli seconds
    ...
    Then I click on datepicker button to select the admit date on add a new transition
    Then I click on the centre of the calendar header to select date and month on Transition Page
    Then I click on the previous next link to select the required year "23" on date picker
    ...
    Then I wait for 5000 milli seconds
    Then I select the "Working" DRG type on the Diagnosis and DRG tab on add a new transition
    Then I select the "239" DRG on the Diagnosis and DRG tab on add a new transition
    Then I wait for 5000 milli seconds
    Then I click on the Create Transition Button to add a new transition
