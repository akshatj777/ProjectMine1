...
Scenario Outline: Patient with Pending Cancellation episode having readmission to an ACH facility as HHH-I without DRG
 ...
 Examples:
   ...
   #Scenario 2
   Scenario Outline: Patient's latest readmission admit/discharge care setting is HOM
 ...
 Examples:
      ...
      | qa.admin@yopmail.com | Episode1! |  ABHIS           |  KUMAutomate          |   HHH - Hospital  | Inpatient | Stamford Hospital | 6 |Working | 65  | 2/5/2017//14:00-14:30 | 10/5/2017//14:00-14:30 | 1 |  
