...
Scenario Outline: Patient's current care setting is SNF (Skilled Nursing, TCU) Episode state Future Active
   Given I am on the login page
    ...
    And I wait for 2000 milli seconds
    And I Select "Coosa valley health care" from admitting facility list present on the Add Patient page
    And I wait for 4000 milli seconds
   ...
   Examples:
      ...
      | qa.admin@yopmail.com | Episode1! | PATIENT             | AUTOMATEWORKLIST  |  
