...
Feature: Veirify Readmission status with anchor discharge


 Scenario Outline: Readmission Login (Adding new Active tranistion with dates between Admit and discharge date )
    ...
    Then I click on datepicker button to select the admit date on add a new transition
    Then I click on the centre of the calendar header to select date and month on Transition Page
    Then I click on the previous next link to select the required year "<AdmitDate2>" on date picker
    ...
    Examples:
      ...
      | qa.admin@yopmail.com | Episode1! | PURPOSEISA           | TOAUTOMATZZ            |   HHH - Hospital  | Inpatient | Stamford Hospital | 3 |Working | 65  | 2/5/2017//14:00-14:30 | 4/5/2017//14:00-14:30 | 3/5/2017//14:00-14:30 | Allentown  |
    ...
    Then I select the care type value "<Care type>" on add a new transition
    Then I wait for 5000 milli seconds
    Then I select the facility value "<new facility value>" on add a new transition
    Then I wait for 12000 milli seconds
    Then I click on the Diagnosis and DRG tab on add a new transition to select the DRG
    Then I wait for 5000 milli seconds
    Then I click on the Create Transition Button to add a new transition
    ...
    Examples:
      ...
      | email                | password  | Patient First Name  | Patient Last Name | CareSettingValue | Care type | facility value    | LOS | DRG type | DRG | Admitdate |  Dischargedate | AdmitDate2 | new facility value |
      | qa.admin@yopmail.com | Episode1! | PURPOSEISA           | TOAUTOMRE            |   HHH - Hospital  | Inpatient | Stamford Hospital | 3 |Working | 65  | 2/5/2017//14:00-14:30 | 4/5/2017//14:00-14:30 | 3/5/2017//14:00-14:30 | Allentown  |
 ...
 Examples:
      ...
      | qa.admin@yopmail.com | Episode1! |  PURPOSEISA           | TOAUTOMRE            |   HHH - Hospital  | Inpatient | Stamford Hospital | 4 |Working | 63  | 2/5/2017//14:00-14:30 | 10/5/2017//14:00-14:30 |     
