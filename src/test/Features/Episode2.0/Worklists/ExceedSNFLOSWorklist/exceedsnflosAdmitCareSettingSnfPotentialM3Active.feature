Feature: Patient status on Exceed SNF LOS Work List
  ...
  Scenario Outline: Exceed SNF Los woth admit care setting snf and potential M3 active patient
    ...
    Then I select the "29" from the calendar from date picker on Transition Page
    Then I select the "29" time from the calendar from date picker on Transition Page
