Feature: Create HHA organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Create HHA Organization with Mandatory fields - Without MO                                       | NO     |              | HHANAME              | Address1                                                |                                               |                                                         | City                                          | California |       10000 |         |         | CCN |     |     | HHA Organization Successfully Created.                                                        |
      | Create HHA Organization with Mandatory fields + ShortName - Without MO                           | NO     |              | HHANAME              | Address1                                                | Short_Name                                    |                                                         | City                                          | California |       10000 |         |         | CCN |     |     | HHA Organization Successfully Created.                                                        |
