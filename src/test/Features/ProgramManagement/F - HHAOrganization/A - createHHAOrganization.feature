Feature: Create HHA organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit edge condition for HHA name field - Without MO                                               | NO     |              | abcdefghijklmnopqrstuvwxyzabcdefghijklmnotuvwxyzabcdefghijklmnopqrstuvwxqjh | Address1                                                | Short_Name                                    | Address2                                                | City                                          | California |       10000 | Midwest | Chicago | CCN | EIN | NPI | Success! HHA Organization Successfully Created.                                                         |
