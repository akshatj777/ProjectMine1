Feature: Create HHA organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit edge condition for HHA name field - Without MO                             | NO     |              | abcdefghijklmnopqrstuvwxyzabcdefghabcdmnotuvwxyzabcdefghijklmnopqrstuvwxqjh | Address1                                                | Short_Name                                    | Address2                                                | City                                          | California |       10000 | Midwest | Chicago | CCN | EIN | NPI | Success! HHA Organization Successfully Created.                                                         |
      ...
      | Create HHA Organization with Mandatory fields + ShortName + Address2 + Region + Market - With MO | YES    | MONAME       | HHANAME                                                                     | Address1                                                | Short_Name                                    | Address2                                                | City                                          | California |       10000 | Midwest | Chicago | CCN |     |     | Success! HHA Organization Successfully Created.                                                         |
      | Create HHA Organization with Mandatory fields + Address2 + Address2 - Without MO                 | NO     |              | HHANAME                                                                     | Address1                                                |                                               | Address2                                                | City                                          | California |       10000 |         |         | CCN |     |     | Success! HHA Organization Successfully Created.                                                         |
