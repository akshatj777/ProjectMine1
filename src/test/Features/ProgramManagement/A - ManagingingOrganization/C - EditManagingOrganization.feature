...
#
    #Examples: 
      ...
      #| Check Character Limit for Postal code field on Edit Managing Organization page     | MONAME  |                                                                              |                                                           |                                                |                                                           |                                                                                                                                                                                                                                                                     |                                                |               |       | 10000-00000 | Please enter a Postal Code                                     |
      ...
      #| Check Allowed Characters for PostalCode field on Edit Managing Organization page   | MONAME  |                                                                              |                                                           |                                                |                                                           |                                                                                                                                                                                                                                                                     |                                                |               |       | abcdefgh    | Please enter a Postal Code                                     |
#
  Scenario Outline: <Description>
    When I click on Organization link on Program Management page
    Then I search with "<MO_Name>" on organization in search box
