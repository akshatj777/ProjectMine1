Feature: Create Managing organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit edge condition for City field                                            | MONAME               | ContactPersonTest                             | Sample@yopmail.com                            |    5555599999 | Address1                                                | Address2                                                | abcdefghijklmnopqrstuvwxyzabcdefgayopmailccom | New York |       10001 | Managing Organization Successfully Created.                                                    |
      | Check Character Limit edge condition for ContactPhone field                                    | MONAME               | ContactPersonTest                             | Sample@yopmail.com                            |    9988956468 | Address1                                                | Address2                                                | City                                          | New York |       10001 | Managing Organization Successfully Created.                                                    |
