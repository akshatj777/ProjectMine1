Feature: Create Managing organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Allowed Characters for PostalCode field   | !@$% ^&*()_+}{:< >?=-\\/.5426MOName                                          | !@$% ^&*()_+}{:< >?=-\\/.5426Address1                     | !@$% ^&*()+}{;:<>?=-\\/.,Contact_person001     | !@$% ^&*()_+}{:< >?=-\\/.5426Address2                     | !$%^&==-Testing120@gmail.com                   | !@$% ^&*()_+}{:< >?=-\\/.5426city              |      9816123123 | abcdefgh    | Please enter a valid Zip Code                                  |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit edge condition for MOName field                                          | equalsTo75Characters                | ContactPersonTest                             | Sample@yopmail.com                            |     5555599999 | Address1                                                | Address2                                                | City                                          | New York |       10001 | Managing Organization Successfully Created.                                                      |
      ...
      | Check Character Limit edge condition for ContactPhone field                                    | MONAME                              | ContactPersonTest                             | Sample@yopmail.com                            | 234-235-5678   | Address1                                                | Address2                                                | City                                          | New York |       10001 | Managing Organization Successfully Created.                                                      |
      ...
      | To check the Allowed characters for the available fields                                       | !@$% ^&*()_+}{:< >?=-\\/.5426MOName | !@$% ^&*()+}{;:<>?=-\\/.,Contact_person001    | !$%^&*'.-=+Contact_Email001@gmail.com         | 1(235)526 5236 | !@$test% ^&2356*()_+}{;:<>?=-\\/.,Address1              | !@$test% ^&2356*()_+}{;:<>?=-\\/.,Address2              | !@$test% ^&2356*()_+}{;:<>?=-\\/.,City        | New York |       10001 | Managing Organization Successfully Created.                                                      |
