...
#
    #Examples: 
      ...
      #| Validation when Physician Roster End Date is greater than Bundle Payment Contract End Date on Edit Physician Roster page                 | NO     | PGPNAME  | PROGRAMNAME  | PGPNAME               |         123 | pc211917         | firstName | testLastName | pc211917 | 2019/12/27        | 2019/12/26      | The start date and end date are not valid.                         |
...
#
  #Scenario Outline: <Description>
    ...
    #Then I enter date "<PhysicianEndDate>" in "PhysicianEndDate" field for index "1"
    #Then I click on "Submit" button on "create" organization page
    #Then I verify "<Message>" after submitting the "edit Physician Roster" on Payor organization page
#
    #Examples: 
    ...
    Examples: 
      ...
      | Editable fields for Physician and To verify user is not allowed to edit the non-editable fields | NO     | ACHNAME  | PROGRAMNAME  | ACHNAME               | pc211917         | firstName | testLastName | pc211917 | 2017/01/30 | 2017/06/30 |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Validation message if Start Date is left blank on edit Physician Roster page | NO     | ACHNAME  | PROGRAMNAME  | ACHNAME               |         123 | 2017-01-09 | 2019-12-26 | pc211917         | firstName | testLastName | pc211917 | The start date is before the start of the Bundled Payment Contract |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                                                          | Has_MO | Hosp_Name | Program_Name | Hospital_Organization_Name | Contract_ID | Start_Date | End_Date   | Physician_Roster | FirstName | LastName     | NPI      | ValidationMessage                                             |
      | Validation message if End Date is left blank when Bundle Payment Contract has End Date on Edit Physician Roster page | NO     | ACHNAME  | PROGRAMNAME  | ACHNAME               |         123 | 2017-01-09 | 2019-12-26 | pc211917         | firstName | testLastName | pc211917 | The end date is after the end of the Bundled Payment Contract |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                                                                              | Has_MO | Hosp_Name | Program_Name | Hospital_Organization_Name | Contract_ID | Physician_Roster | FirstName | LastName     | NPI      | ContractStartDate | ContractEndDate | ValidationMessage                                                  |
      | Check validation message when Physician Roster Start Date is prior to Bundle Payment Contract Start Date on Edit Physician Roster page   | NO     | ACHNAME  | PROGRAMNAME  | ACHNAME               |         123 | pc211917         | firstName | testLastName | pc211917 | 2017/01/08        | 2019/12/26      | The start date is before the start of the Bundled Payment Contract |
      | Check validation message when Physician Roster Start Date is greater than Bundle Payment Contract End Date on Edit Physician Roster page | NO     | ACHNAME  | PROGRAMNAME  | ACHNAME               |         123 | pc211917         | firstName | testLastName | pc211917 | 2019/12/27        | 2019/12/26      | The start date and end date are not valid.                         |
      | Validation when Physician Roster Start Date is greater than Physician Roster End Date on Edit Physician Roster page                      | NO     | ACHNAME  | PROGRAMNAME  | ACHNAME               |         123 | pc211917         | firstName | testLastName | pc211917 | 2019/12/02        | 2019/12/01      | The start date and end date are not valid.                         |
      | Validation when Physician Roster End Date is greater than Bundle Payment Contract End Date on Edit Physician Roster page                 | NO     | ACHNAME  | PROGRAMNAME  | ACHNAME               |         123 | pc211917         | firstName | testLastName | pc211917 | 2019/12/27        | 2019/12/26      | The start date and end date are not valid.                         |
      | Validation when Physician Roster End Date is prior to Bundle Payment Contract Start Date on Edit Physician Roster page                   | NO     | ACHNAME  | PROGRAMNAME  | ACHNAME               |         123 | pc211917         | firstName | testLastName | pc211917 | 2017/01/30        | 2017/01/28      | The start date and end date are not valid.                         |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                      | Has_MO | Hosp_Name | Program_Name | Hospital_Organization_Name | Contract_ID | Physician_Roster | FirstName | LastName     | NPI      | PhysicianStartDate | PhysicianEndDate | ValidationMessage                                                                                                    |
      | Validation when Physician Start and End Dates are edited with same dates         | NO     | ACHNAME  | PROGRAMNAME  | ACHNAME               |         123 | pc211917         | firstName | testLastName | pc211917 | 2018/04/02         | 2018/04/02       | Validation errors: Require valid date range. End date (if specified) should be less a future date to the start date. |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Edit and save a physician with all the available fields | NO     | ACHNAME  | PROGRAMNAME  | ACHNAME               | pc211917         | 2017/01/30         | 2017/06/30       | Physicians Successfully Updated |
      | Edit and save a physician with all the available fields | YES    | ACHNAME  | PROGRAMNAME  | ACHNAME               | pc211917         | 2018/07/01         | 2018/12/01       | Physicians Successfully Updated |
