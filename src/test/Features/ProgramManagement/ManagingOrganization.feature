Feature: Create a Managing Organization, verify the details fields
  ...
  Scenario Outline: Edit and save changes for all fields of Managing Organization
    ...
    Then I click on "Submit" button on create organization page
    When I search edited with <MO_Name> on organization in search box
    And I edited click <MO_Name> field in search list on organization page
    ...
    Examples: 
      ...
      | NewMngOrg | MONAME   | ContactPersonTest | contact_email@yopmail.com |    4567891230 | 7th Floor | Street XI | Test | California |       10000 |
