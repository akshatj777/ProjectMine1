Feature: Create payor org test
  ...
  Scenario Outline:
    ...
    Examples:
      ...
      | Payorone | valid management org data | aptest20@gmail.com | 212-567-8970 | ADDR1    | 7th floor | Arizona | NY    | 10020 | 1234567890 | Success! Payor Organization Successfully Created. |
