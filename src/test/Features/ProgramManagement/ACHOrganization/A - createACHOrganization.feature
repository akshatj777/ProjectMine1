Feature: Create Hospital organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    And I provide unique CCN "<CCN>" in "CCN" on create organization page
    And I provide unique EIN "<EIN>" in "EIN" on create organization page
    And I provide unique NPI "<NPI>" in "NPI" on create organization page
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit for CCN field                  |                                                                              |                                                |                                                |                                                |                                                |             |                                                                              |                                                |                                                |                                                |                 |       67394 |              |              | The CCN must be at least 6 characters.                         |
      | Check Character Limit for CCN field                  |                                                                              |                                                |                                                |                                                |                                                |             |                                                                              |                                                |                                                |                                                |                 | 89654963566 |              |              | The CCN may not be greater than 10 characters.                 |
      | Check Character Limit for EIN field                  |                                                                              |                                                |                                                |                                                |                                                |             |                                                                              |                                                |                                                |                                                |                 |             | 689345689652 |              | The EIN may not be greater than 10 characters.                 |
      | Check Character Limit for NPI field                  |                                                                              |                                                |                                                |                                                |                                                |             |                                                                              |                                                |                                                |                                                |                 |             |              |  89648593269 | The NPI may not be greater than 10 characters.                 |
      ...
      | Check Allowed Characters for postal code field       |                                                                              |                                                |                                                |                                                |                                                |             |                                                                              |                                                |                                                |                                                | helloheh        |             |              |              | Please enter a valid Zip Code                                  |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                             | Hosp_Name | Address1 | Short_Name | Address2 | City | State      | Postal_Code | Loc_Name | Loc_Address1 | Loc_Type  | Loc_Region | Loc_Market | Loc_Address2 | Loc_City | Loc_State  | Loc_Postal_Code | CCN | EIN | NPI | Message                                              |
      | Create Hospital Organization with all the available fields - Without MO | ACHName   | Address1 | Short_Name | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10000 | CCN | EIN | NPI | Success! Hospital Organization Successfully Created. |
