Feature: Edit SNF organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check validation for blank Location Postal code | NO     | SNFNAME  | SNFNAME         | Address1     | City     | California |           10000 | LocName  | LAddress1    | LCity    | California |                 | Please enter a Postal Code        |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit edge condition for SNF Organization Name field on Edit SNF Organization page - Without MO  | NO     | SNFNAME  | equalsTo75Characters |                                                         | Short_Name                                    | Address2                                                | City                                          | California |           10000 | Loc_Name                                                                    | Loc_Address1                                            | Skilled Nursing | Midwest    | Chicago    | Loc_Address2                                            | Loc_City                                      | California |           10000 | SNF Organization Successfully Updated. |
  ...
  Scenario Outline: <Description>
    ...
    And I edit "postalCode" field to <Loc_Postal_Code> for Location "1" for organization
    Then I click on "Submit" button on "Edit" organization page
    Then I verify duplicate "<Message>" after submitting the "edit SNF - <Has_MO>" organization page

    Examples: 
      | Description                                                             | Has_MO | SNF_Name | Edited_SNF_Name | Org_Address1 | Short_Name | Org_Address2 | City | State      | Org_Postal_Code | Loc_Name | Loc_Address1 | Loc_Type | Loc_Region | Loc_Market | Loc_Address2 | Loc_City | Loc_State  | Loc_Postal_Code | Message                                                                                          |
      | Edit duplicate SNF Organization name with Mandatory fields - Without MO | NO     | SNFNAME  | DUPLICATE_SNF   | Address1     |            |              | City | California |           10000 | Loc_Name | Loc_Address1 |          |            |            |              | Loc_City | California |           10000 | There is a conflict error because an entity with similar identifying attributes already existed. |
      | Edit duplicate SNF Organization name with Mandatory fields - With MO    | YES    | SNFNAME  | DUPLICATE_SNF   | Address1     |            |              | City | California |           10000 | Loc_Name | Loc_Address1 |          |            |            |              | Loc_City | California |           10000 | There is a conflict error because an entity with similar identifying attributes already existed. |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                | Has_MO | SNF_Name | Loc_Name   | Loc_Address1   | Loc_Type        | Loc_Region | Loc_Market | Loc_Address2  | Loc_City  | Loc_State  | Loc_Postal_Code | Message                                |
      | Add one more location Location details on SNF Organization | NO     | SNFNAME  | Loc_Name12 | Loc_Address123 | Skilled Nursing | Midwest    | Chicago    | Loc_Address22 | Loc_City1 | California |           10001 | SNF Organization Successfully Updated. |
