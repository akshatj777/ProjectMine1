Feature: Edit SNF organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check validation for blank Location Postal code | YES    | SNFNAME  | SNFNAME         | Address1     | City     | California |           10000 | LocName  | LAddress1    | LCity    | California |                 | Please enter a Postal Code|
