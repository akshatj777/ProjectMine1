Feature: Create SNF organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                                                        | Has_MO | Managing_Org | SNF_Name                                                                    | Address1                                                | Short_Name                                    | Address2                                                | City                                          | State      | Postal_Code | Loc_Name                                                                    | Loc_Address1                                            | Loc_Type        | Loc_Region | Loc_Market | Loc_Address2                                            | Loc_City                                      | Loc_State  | Loc_Postal_Code | CCN | EIN | NPI | Message                                                                                                 |
      | Check Character Limit edge condition for SNF name field - Without MO                                               | NO     |              | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrszabcdefghijklmnopqrsjklmnqrs | Address1                                                | Short_Name                                    | Address2                                                  | City                                          | California |       10000 | Loc_Name                                                                    | Loc_Address1                                            | Skilled Nursing | Midwest    | Chicago    | Loc_Address2                                            | Loc_City                                      | California |           10000 | CCN | EIN | NPI | Success! SNF Organization Successfully Created.                                                         |
