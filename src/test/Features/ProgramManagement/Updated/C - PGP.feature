Feature: User completes inputting PGP Organization details during creation,
  ...
  Scenario Outline: Create a PGP organization with valid data (With Managing Organization)
    ...
    Examples: 
      ...
      | 26 Automate Manag Orgg | PGP          | ShrtName   | West   | Oil States | Floor 9th | Building E | Test | New York |       10000 | NY                 |
 ...
 Scenario Outline: Create a PGP organization with valid data (Without Managing Organization)
    ...
    Examples: 
     | PGP_Org_Name | Short_Name | Region | Market     | Address1  | Address2   | City | State    | Postal_Code | State_verification |
     | PGP          | ShrtName   | West   | Oil States | Floor 9th | Building E | Test | New York |       10000 | NY                 |
