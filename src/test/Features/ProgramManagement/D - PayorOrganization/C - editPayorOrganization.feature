Feature: Edit Payor organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit edge condition for PAYOR NAME field on Edit Payor Organization        | PAYOPRNAME | equalsTo75Characters | ContactPersonTest                             | Sample@yopmail.com                            |    5555599999 | Address1                                                | Address2                                                | City                                          | New York |       10001 | Payor Organization Successfully Updated. |
      | Check Character Limit edge condition for Address1 field on Edit Payor Organization          | PAYOPRNAME | PAYOPRNAME           | ContactPersonTest                             | Sample@yopmail.com                            |    5555599999 | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstabcasabcd | Address2                                                | City                                          | New York |       10001 | Payor Organization Successfully Updated. |
      | Check Character Limit edge condition for ContactPerson field on Edit Payor Organization     | PAYOPRNAME | PAYOPRNAME           | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqab | Sample@yopmail.com                            |    5555599999 | Address1                                                | Address2                                                | City                                          | New York |       10001 | Payor Organization Successfully Updated. |
      | Check Character Limit edge condition for Address2 field on Edit Payor Organization          | PAYOPRNAME | PAYOPRNAME           | ContactPersonTest                             | Sample@yopmail.com                            |    5555599999 | Address1                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstabcasabcd | City                                          | New York |       10001 | Payor Organization Successfully Updated. |
      | Check Character Limit edge condition for ContactEmail field on Payor Payor Organization     | PAYOPRNAME | PAYOPRNAME           | ContactPersonTest                             | abcdefghijklmnopqrstuvwxyzabcdefg@yopmail.com |    5555599999 | Address1                                                | Address2                                                | City                                          | New York |       10001 | Payor Organization Successfully Updated. |
      | Check Character Limit edge condition for City field on Edit Payor Organization              | PAYOPRNAME | PAYOPRNAME           | ContactPersonTest                             | Sample@yopmail.com                            |    5555599999 | Address1                                                | Address2                                                | abcdefghijklmnopqrstuvwxyzabcdefgayopmailccom | New York |       10001 | Payor Organization Successfully Updated. |
      | Check Character Limit edge condition for ContactPhone field on Edit Payor Organization      | PAYOPRNAME | PAYOPRNAME           | ContactPersonTest                             | Sample@yopmail.com                            |    9988956468 | Address1                                                | Address2                                                | City                                          | New York |       10001 | Payor Organization Successfully Updated. |
      | Check Character Limit edge condition for Postal code field on Edit Payor Organization       | PAYOPRNAME | PAYOPRNAME           | ContactPersonTest                             | Sample@yopmail.com                            |    5555599999 | Address1                                                | Address2                                                | City                                          | New York | 10001-5623  | Payor Organization Successfully Updated. |
