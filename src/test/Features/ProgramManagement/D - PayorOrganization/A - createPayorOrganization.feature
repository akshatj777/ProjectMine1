Feature: Create Payor organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Verify Validation Payor Organization with duplicate EIN |                                                                              |                                                |                                                |                                                |                                                |                                                |                    |       |             | DUPLICATE_EIN | EIN Id already taken                                           |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                                 | MO_Name             | Contact_Person    | Contact_Email      | Contact_Phone | Address1 | Address2 | City | State    | Postal_Code | EIN                                                                                                     | Message                                           |
