Feature: Create Payor organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Create Payor Organization with Mandatory fields + ContactPerson                              | PAYORNAME           | ContactPersonTest |                    |               | Address1 |          | City | New York |       10001 |     | Success! Payor Organization Successfully Created.                                                       |
      ...
      | Create Payor Organization with Mandatory fields + Address2 + ContactPerson + EIN              | PAYORNAME           | ContactPersonTest |                    |               | Address1 | Address2 | City | New York |       10001 | EIN | Success! Payor Organization Successfully Created.                                                       |
      ...
      | Create Payor Organization with Mandatory fields + Address2 + ContactPerson + ContactEmail     | PAYORNAME           | ContactPersonTest | Sample@yopmail.com |               | Address1 | Address2 | City | New York |       10001 |     | Success! Payor Organization Successfully Created.                                                       |
      | Create Payor Organization with Mandatory fields + ContactEmail + ContactPerson + ContactPhone | PAYORNAME           | ContactPersonTest | Sample@yopmail.com |    5555599999 | Address1 |          | City | New York |       10001 |     | Success! Payor Organization Successfully Created.                                                       |
      | Create Payor Organization with Mandatory fields + ContactEmail + ContactPerson                | PAYORNAME           | ContactPersonTest | Sample@yopmail.com |    5555599999 | Address1 |          | City | New York |       10001 |     | Success! Payor Organization Successfully Created.                                                       |
      ...
      | Create Payor Organization with Mandatory fields + ContactPhone + ContactPerson + Address2     | PAYORNAME           | ContactPersonTest |                    |    5555599999 | Address1 | Address2  | City | New York |       10001 |     | Success! Payor Organization Successfully Created.                                                       |
