Feature: Create Hospital org with one location
  ...
  Scenario Outline:
    ...
    Given Enter hospital data and click on submit  "<name>" and "<shortName>" and "<ccn>" and "<ein>" and "<npi>" and "<address1>" and "<address2>" and "<city>" and "<state>" and "<zip>" and "<locationName>" and "<locationType>" and "<marketId>" and "<regionId>"
    ...
    Examples:
      ...
      | hospOneLoc | aptestShortName | 1234567890 | 1234567890 | 1234567890 | 256 5th ave | 7th floor | NewYork | NY    | 10020 | apLocationName | 4            | 7        | 2        | Success! Hospital Organization Successfully Created. |
