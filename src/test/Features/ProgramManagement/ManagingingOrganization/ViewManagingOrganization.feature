Feature: View the Managing organization
  ...
  Scenario Outline: View managing organization and also verify Details displayed for associated organization
    ...
    And I verify "HHA" organization present under "Managing" Organization
  ...
  Scenario Outline: To verify that the count is increased by 1, when a Organization is associated
    ...
    Examples: 
      | MO_Name       | Hosp_Org_Name | Contact_Person    | Contact_Email      | Contact_Phone | Address1 | Address2 | City | State    | Postal_Code | CCN | EIN | NPI | Loc_Name | LAddress1 | LAddress2 | LCity | LState   | LPostal_Code | StateInitials | ParticipantId |
      | EditTestMnOrg | ACH           | ContactPersonTest | Sample@yopmail.com |    5555599999 | Address1 | Address2 | City | New York |       10001 | CCN | EIN | NPI | way123   | LAddress  | hosadd    | LCity | New York |        10030 | NY            | Sample        |
