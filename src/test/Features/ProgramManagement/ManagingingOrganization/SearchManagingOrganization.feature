Feature: Search the Managing organization
  ...
  Scenario Outline: Search after editing the Managing organization name
    ...
    And I click <MO_Name1> field in search list on organization page
    ...
    Examples: 
      ...
      | cCtrHManOrgKbNJmokq3823 | cCtrHManOrgNJmokq3823 | ContactPersonTest | Sample1@yopmail.com |    5555599999 | EditedAddress1 | EditedAddress12 | EditedCity | New York |       10001 | NY            | Sample        |
