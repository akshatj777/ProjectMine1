Feature: Create Managing organization
  ...
  Scenario Outline: Verification of Field Charcter Limits and Format
    ...
    Examples: 
      ...
      | @$%%^%124&68jkk*6()$@!                                                       | !@$%^56%12**4&68jkk*6()$@!                     | %^&*876%6%&^5                                  | %^&*876%6%5                                    | @$%%6%^7$^&%@yopmail.com                       | 3$%^4&^@56                                     |   98745612301 | California | abcdefgh    |                                                              |                                                               |                                                           |                                                                | The Contact Email format is invalid.                     |                                                 | The Contact Phone format is invalid. | Please enter a valid Zip Code |
