Feature: Create Managing organization
  ...
  Scenario Outline: Verification of Field Charcter Limits and Format
    ...
    Examples: 
      ...
      | @$%%^%124&68jkk*6()$@!                                                       | !@$%^56%12**4&68jkk*6()$@!                     | %^&*876%6%&^5                                  | %^&*876%6%5                                    | @$%%6%^7$^&%@yopmail.com                        | 3$%^4&^@56                                     |   98745612301 | California | 10000-0000  |                                                              |                                                               |                                                           |                                                                | The Contact Email format is invalid.                     |                                                 | The Contact Phone format is invalid. |                               |
  ...
  Scenario Outline: Create Managing Organization with Mandatory fields only and Create using duplicate Manging Organization Name.
    ...
    Examples: 
      ...
      | MONAME  | Address1 | City | California |       10000 |

  Scenario Outline: Create using duplicate Manging Organization Name.
    When I click on Organization link on Program Management page
    Then I click on create new Organization button on Program Management homepage
    And I verify "Create Management Organization" header text on create organization page
    Then I enter <MO_Name> in "Managing Organization Name" on create organization page
    ...
    Examples: 
      | MO_Name        | Address1 | City | State      | Postal_Code |
      | newmo edited12 | Address1 | City | California |       10000 |

  Scenario Outline: Create a Manging organization with valid data
  ...
  Scenario Outline: Create a Manging organization without Contact information
    ...
    Examples: 
      | MO_Name | Address1 | Address2 | City | State    | Postal_Code | 
      | MONAME  | Address1 | Address2 | City | New York |       10001 | 
