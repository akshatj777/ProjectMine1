Feature: Create Managing organization functionality tests
  ...
  Scenario Outline: Verification of field validation for blank mandatory fields on Create Managing Organization page
    When I click on Organization link on Program Management page
    Then I click on create new Organization button on Program Management homepage
    And I verify "Create Management Organization" header text on create organization page
  ...
  Scenario Outline: Verification of character limits/formats for relevant fields on Create Managing Organization page.
    When I click on Organization link on Program Management page
    Then I click on create new Organization button on Program Management homepage
    And I verify "Create Management Organization" header text on create organization page
    Then I enter <MO_Name> in "Managing Organization Name" on create organization page
    ...
    And I verify "<ValidatioMessage>" mandatory field validation message on create organization page

    Examples: 
      | Description                                     | MO_Name                                                                      | Address1                                       | Contact_Person                                 | Address2                                       | Contact_Email                                  | City                                           | Contact_Phone | State | Postal_Code | ValidatioMessage                                               |
  ...
  Scenario Outline: Create a Managing organization with combinations of mandatory and few non mandatory fields.
    When I click on Organization link on Program Management page
    Then I click on create new Organization button on Program Management homepage
    And I verify "Create Management Organization" header text on create organization page
    Then I enter <MO_Name> in "Managing Organization Name" on create organization page
    ...
    Examples: 
      ...
      | Create using duplicate Managing Organization Name                                              | newmo edited12 | ContactPersonTest | Sample@yopmail.com |    5555599999 | Address1 | Address2 | City | New York |       10001 | Oh no! There is a conflict error because an entity with similar identifying attributes already existed. |
