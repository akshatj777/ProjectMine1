Feature: Managing organization functionality tests
  ...
  Scenario Outline: Create Managing Organization with Mandatory fields only and Create using duplicate Manging
  Organization Name.
  When I click on Organization link on Program Management page
  Then I click on create new Organization button on Program Management homepage
  And I verify "Create Management Organization" header text on create organization page
  ...
  | MONAME         | ContactPerson  | Address1 | City | California |       10000 | CA            |           123 |  Success! Management Organization Successfully Created.                                                                                                |
  | newmo edited12 | ContactPerson  | Address1 | City | California |       10000 | CA            |           123 | Oh no! There is a conflict error because an entity with similar identifying attributes already existed. |
