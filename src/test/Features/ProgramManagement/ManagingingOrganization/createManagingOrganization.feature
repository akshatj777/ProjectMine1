Feature: Managing organization functionality tests
  ...
  Scenario Outline: Verification of Field Charcter Limits and Format
    ...
    Examples: 
      | Description                                     | MO_Name                                                                      | Address1                                       | Contact_Person                                 | Address2                                       | Contact_Email                                  | City                                           | Contact_Phone | State | Postal_Code | ValidationOrgName                                            | ValidationAddress                                             | ValidationContactPerson                                   | ValidationAddress2                                             | ValidationContactEmail                                   | ValidationCity                                  | ValidationContactPhone               | ValidationZipCode             |
      | Check Charcter Limit for Mo name field          | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwx |                                                |                                                |                                                |                                                |                                                |               |       |             | The Organization Name may not be greater than 75 characters. |                                                               |                                                           |                                                                |                                                          |                                                 |                                      |                               |
      | Check Charcter Limit for Address1 field         |                                                                              | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |                                                |                                                |                                                |                                                |               |       |             |                                                              | The first address line may not be greater than 45 characters. |                                                           |                                                                |                                                          |                                                 |                                      |                               |
      | Check Charcter Limit for Contact person field   |                                                                              |                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |                                                |                                                |                                                |               |       |             |                                                              |                                                               | The Contact Person may not be greater than 45 characters. |                                                                |                                                          |                                                 |                                      |                               |
      | Check Charcter Limit for Address2 field         |                                                                              |                                                |                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |                                                |                                                |               |       |             |                                                              |                                                               |                                                           | The second address line may not be greater than 45 characters. |                                                          |                                                 |                                      |                               |
      | Check Charcter Limit for Contact Email field    |                                                                              |                                                |                                                |                                                | abcdefghijklmnopqrstuvwxyzabcdefgh@yopmail.com |                                                |               |       |             |                                                              |                                                               |                                                           |                                                                | The Contact Email may not be greater than 45 characters. |                                                 |                                      |                               |
      | Check Charcter Limit for City field             |                                                                              |                                                |                                                |                                                |                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |               |       |             |                                                              |                                                               |                                                           |                                                                |                                                          | The City may not be greater than 45 characters. |                                      |                               |
      | Check Charcter Limit for Contact phone field    |                                                                              |                                                |                                                |                                                |                                                |                                                |   98745612301 |       |             |                                                              |                                                               |                                                           |                                                                |                                                          |                                                 | The Contact Phone format is invalid. |                               |
      | Check Charcter Limit for Postal code field      |                                                                              |                                                |                                                |                                                |                                                |                                                |               |       | 10000-00000 |                                                              |                                                               |                                                           |                                                                |                                                          |                                                 |                                      | Please enter a valid Zip Code |
      | Check Allowed Charcters for Contact Email field |                                                                              |                                                |                                                |                                                | @$%%6%^7$^&%@yopmail.com                       |                                                |               |       |             |                                                              |                                                               |                                                           |                                                                | The Contact Email format is invalid.                     |                                                 |                                      |                               |
      | Check Allowed Charcters for Contact phone field |                                                                              |                                                |                                                |                                                |                                                |                                                |   98745612301 |       |             |                                                              |                                                               |                                                           |                                                                |                                                          |                                                 | The Contact Phone format is invalid. |                               |
      | Check Allowed Charcters for Postal code field   |                                                                              |                                                |                                                |                                                |                                                |                                                |               |       | abcdefgh    |                                                              |                                                               |                                                           |                                                                |                                                          |                                                 |                                      | Please enter a valid Zip Code |

  Scenario Outline: Create a Manging organization mandatory, non-mandatory fields and duplicate MoName.
    When I click on Organization link on Program Management page
    Then I click on create new Organization button on Program Management homepage
    And I verify "Create Management Organization" header text on create organization page
    Then I enter <MO_Name> in "Managing Organization Name" on create organization page
    ...
    And I enter <Postal_Code> in "Postal Code" on create organization page
    Then I click on "Submit" button on create organization page
    Then I verify "<Message>" after submitting the create ogranization page
    ...
    Examples: 
      ...
      | Create using duplicate Manging Organization Name                                               | newmo edited12 | ContactPersonTest | Sample@yopmail.com |    5555599999 | Address1 | Address2 | City | New York |       10001 | Oh no! There is a conflict error because an entity with similar identifying attributes already existed. |
