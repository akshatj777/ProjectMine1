Feature: User completes entering Hospital Organization details during creation process,
  ...
  Scenario Outline: Edit Hospital organization without MO
    ...
    Examples: 
      ...
      | Hosp Org Ach Name | OrgHosp AchName | Street AB | Hos Ach Name | Street BA | City Y | Arizona |       10041 | 14001400 | 15001500 | 12001200 | Test Edit Loca Name | Block A Loca Add | Children | Block BA Loc Add | West     | Desert Island | City New Loc | Kansas  |         79845 | KS                |
