Feature: Cancel Create management org test
  ...
  Scenario Outline:
    ...
    Examples:
      ...
      | name               | contactPerson             | contactEmail       | contactPhone | address1 | address2  | city    | state | zip   |
      | cancelCreateManOrg | valid management org data | aptest20@gmail.com | 212-567-8970 | ADDR1    | 7th floor | Arizona | NY    | 10020 |
