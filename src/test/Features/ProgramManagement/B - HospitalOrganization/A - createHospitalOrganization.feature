Feature: Create Hospital organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit for Location Address2 field                |                                                                              |                                                           |                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst            |                                                |             |                                                |                                                           | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |                                                           |                 |               |               |               | The second address line may not be greater than 55 characters. |
