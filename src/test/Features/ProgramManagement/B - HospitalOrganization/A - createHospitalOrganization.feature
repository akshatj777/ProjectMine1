Feature: Create Hospital organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Create Hospital Organization with Mandatory fields + ShortName + Address2 + Location Type - With MO                     | YES    | MONAME       | ACHNAME              | Address1                                                | Short_Name                                    | Address2                                                | City                                          | California |       10000 | Loc_Name                                                                    | Loc_Address1                                            | Inpatient |            |            |                                                         | Loc_City                                      | California |           10000 | CCN | EIN |     | Success! Hospital Organization Successfully Created.                                                    |
      | Create Hospital Organization with Mandatory fields + ShortName + Address2 + Location Region + Location Market - With MO | YES    | MONAME       | ACHNAME              | Address1                                                | Short_Name                                    | Address2                                                | City                                          | California |       10000 | Loc_Name                                                                    | Loc_Address1                                            |           | Midwest    | Chicago    |                                                         | Loc_City                                      | California |           10000 | CCN | EIN |     | Success! Hospital Organization Successfully Created.                                                    |
      | Create Hospital Organization with Mandatory fields + Address2 + Location Type + Location Address2 - Without MO          | NO     |              | ACHNAME              | Address1                                                |                                               | Address2                                                | City                                          | California |       10000 | Loc_Name                                                                    | Loc_Address1                                            | Inpatient |            |            | Loc_Address2                                            | Loc_City                                      | California |           10000 | CCN | EIN |     | Success! Hospital Organization Successfully Created.                                                    |
