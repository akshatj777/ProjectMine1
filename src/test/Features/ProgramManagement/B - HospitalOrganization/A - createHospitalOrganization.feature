...
Feature: Create Hospital organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                                       | Has_MO | Managing_Org | Hosp_Name            | Address1 | Short_Name | Address2 | City | State      | Postal_Code | Loc_Name | Loc_Address1 | Loc_Type  | Loc_Region | Loc_Market | Loc_Address2 | Loc_City | Loc_State  | Loc_Postal_Code | CCN | EIN | NPI | Message                                     |
      | Create a Hospital Organization with Mandatory Fields and CCN as mandatory identifier - Without MO | NO     |              | equalsTo75Characters | Address1 | Short_Name | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10000 | CCN | EIN | NPI | Hospital Organization Successfully Created. |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                                           | Has_MO | Managing_Org | Hosp_Name            | Address1 | Short_Name | Address2 | City | State      | Postal_Code | Loc_Name | Loc_Address1 | Loc_Type  | Loc_Region | Loc_Market | Loc_Address2 | Loc_City | Loc_State  | Loc_Postal_Code | CCN | EIN | NPI | Message                                     |
      | Create a Hospital Organization with Mandatory Fields and any other identifier except CCN - Without MO | NO     |              | equalsTo75Characters | Address1 | Short_Name | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10000 | CCN | EIN | NPI | Hospital Organization Successfully Created. |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                                                                   | Has_MO | Managing_Org | Hosp_Name | Address1 | Short_Name | Address2 | City | State      | Postal_Code | Loc_Name | Loc_Address1 | Location_ID | Loc_Type  | Loc_Region | Loc_Market | Loc_Address2 | Loc_City | Loc_State  | Loc_Postal_Code | Loc_Name      | CCN | EIN | NPI | Message                                                                                          |
      | verify auto generated location ID when CCN of current organization is already used as location Id for some other organization | NO     |              | ACHNAME   | Address1 | Short_Name | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 |  1234567890 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10001 | Loc_Name new2 | CCN | EIN | NPI | There is a conflict error because an entity with similar identifying attributes already existed. |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                               | Has_MO | Managing_Org | Hosp_Name     | Address1 | Short_Name | Address2 | City | State      | Postal_Code | Loc_Name | Loc_Address1 | Loc_Type | Loc_Region | Loc_Market | Loc_Address2 | Loc_City | Loc_State  | Loc_Postal_Code | CCN | EIN | NPI | Message                                                                                          |
      | Create Duplicate Hospital Organization with Mandatory fields - Without MO | NO     |              | DUPLICATE_ACH | Address1 |            |          | City | California |       10000 | Loc_Name | Loc_Address1 |          |            |            |              | Loc_City | California |           10000 | CCN |     |     | There is a conflict error because an entity with similar identifying attributes already existed. |
      | Create Duplicate Hospital Organization with Mandatory fields - With MO    | YES    | MONAME       | DUPLICATE_ACH | Address1 |            |          | City | California |       10000 | Loc_Name | Loc_Address1 |          |            |            |              | Loc_City | California |           10000 | CCN |     |     | There is a conflict error because an entity with similar identifying attributes already existed. |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Create Hospital Organization with duplicate NPI- With MO    | YES    |              | ACHNAME   | Address1 | Short_Name | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10000 | CCN | EIN           | DUPLICATE_NPI | Hospital Organization Successfully Created. |
      | Create Hospital Organization with duplicate EIN- With MO    | YES    |              | ACHNAME   | Address1 | Short_Name | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10000 | CCN | DUPLICATE_EIN | NPI           | Hospital Organization Successfully Created. |
