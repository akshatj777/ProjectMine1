Feature: Create Hospital organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Create and verify Hospital Organization with Same multiple location details - Without MO | NO     | MONAME       | ACHNAME   | Address1 | Short_Name | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10000 | CCN | EIN | NPI | Success! Hospital Organization Successfully Created. |
      | Create and verify Hospital Organization with Same multiple location - With MO            | YES    | MONAME       | ACHNAME   | Address1 | Short_Name | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10000 | CCN | EIN | NPI | Success! Hospital Organization Successfully Created. |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Create Hospital Organization with different details in multiple location - Without MO | NO     | MONAME       | ACHNAME   | Address1 | Short_Name | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10000 | Loc_Name1 | CCN | EIN | NPI | Success! Hospital Organization Successfully Created. |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Create Hospital Organization with 10 location - Without MO | NO     | MONAME       | ACHNAME   | Address1 | Short_Name | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10000 | Loc_Name1 | Loc_Name2 | Loc_Name3 | Loc_Name4 | Loc_Name5 | Loc_Name6 | Loc_Name7 | Loc_Name8 | Loc_Name9 | Loc_Name10 | CCN | EIN | NPI | Success! Hospital Organization Successfully Created. |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                                                             | Has_MO | Managing_Org | Hosp_Name     | Address1 | Short_Name | Address2 | City | State      | Postal_Code | Loc_Name | Loc_Address1 | Loc_Type  | Loc_Region | Loc_Market | Loc_Address2 | Loc_City | Loc_State  | Loc_Postal_Code | CCN | EIN | NPI | Message                                                                                                 |
      | Create Hospital Organization with Mandatory fields - Without MO                                                         | NO     | MONAME       | ACHNAME       | Address1 |            |          | City | California |       10000 | Loc_Name | Loc_Address1 |           |            |            |              | Loc_City | California |           10000 | CCN |     |     | Success! Hospital Organization Successfully Created.                                                    |
      | Create Hospital Organization with Mandatory fields + ShortName - Without MO                                             | NO     | MONAME       | ACHNAME       | Address1 | Short_Name |          | City | California |       10000 | Loc_Name | Loc_Address1 |           |            |            |              | Loc_City | California |           10000 | CCN |     |     | Success! Hospital Organization Successfully Created.                                                    |
      | Create Hospital Organization with Mandatory fields + Address2 - Without MO                                              | NO     | MONAME       | ACHNAME       | Address1 |            | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 |           |            |            |              | Loc_City | California |           10000 | CCN | EIN |     | Success! Hospital Organization Successfully Created.                                                    |
      | Create Hospital Organization with Mandatory fields + Location Type - Without MO                                         | NO     | MONAME       | ACHNAME       | Address1 |            |          | City | California |       10000 | Loc_Name | Loc_Address1 | Inpatient |            |            |              | Loc_City | California |           10000 | CCN | EIN |     | Success! Hospital Organization Successfully Created.                                                    |
      | Create Hospital Organization with Mandatory fields + Location Address2 - Without MO                                     | NO     | MONAME       | ACHNAME       | Address1 |            |          | City | California |       10000 | Loc_Name | Loc_Address1 |           |            |            | Loc_Address2 | Loc_City | California |           10000 | CCN | EIN |     | Success! Hospital Organization Successfully Created.                                                    |
      | Create Hospital Organization with Mandatory fields + Location Region - With MO                                          | YES    | MONAME       | ACHNAME       | Address1 |            |          | City | California |       10000 | Loc_Name | Loc_Address1 |           | Midwest    |            |              | Loc_City | California |           10000 | CCN | EIN |     | Success! Hospital Organization Successfully Created.                                                    |
      ...
      | Create Hospital Organization with Mandatory fields + Address2 + Location Type + Location Address2 - Without MO          | NO     | MONAME       | ACHNAME       | Address1 |            | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 | Inpatient |            |            | oc_Address2  | Loc_City | California |           10000 | CCN | EIN |     | Success! Hospital Organization Successfully Created.                                                    |
      ...
      | Create Hospital Organization with all the available fields - Without MO                                                 | NO     | MONAME       | ACHNAME       | Address1 | Short_Name | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10000 | CCN | EIN | NPI | Success! Hospital Organization Successfully Created.                                                    |
