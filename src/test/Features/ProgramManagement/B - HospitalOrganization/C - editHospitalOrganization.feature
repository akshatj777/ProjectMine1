Feature: Edit Hospital organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit for Location Address1 field on Edit Hospital Organization page       | YES    | ACHNAME   |                                                                              |                                                |                                                |                                                |                                                |             |                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |                                                |                                                |                 | The first address line may not be greater than 45 characters.  |
      | Check Character Limit for Location Address2 field on Edit Hospital Organization page       | YES    | ACHNAME   |                                                                              |                                                |                                                |                                                |                                                |             |                                                |                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |                                                |                 | The second address line may not be greater than 45 characters. |
