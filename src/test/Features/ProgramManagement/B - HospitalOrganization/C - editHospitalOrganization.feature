Feature: Edit the Hospital organization
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit for Postal code field on Edit Hospital Organization page             | NO     | ACHNAME   |                                                                              |                                                |                                                |                                                |                                                | 10000-00000 |                                                |                                                |                                                |                                                |                 | Please enter a valid Zip Code                                  |
      | Check Character Limit for Location name field on Edit Hospital Organization page           | NO     | ACHNAME   |                                                                              |                                                |                                                |                                                |                                                |             | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |                                                |                                                |                                                |                 | The locationName may not be greater than 45 characters.        |
      | Check Character Limit for Location Address1 field on Edit Hospital Organization page       | NO     | ACHNAME   |                                                                              | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |                                                |                                                |                                                |             |                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |                                                |                                                |                 | The first address line may not be greater than 45 characters.  |
      | Check Character Limit for Location Address2 field on Edit Hospital Organization page       | NO     | ACHNAME   |                                                                              |                                                |                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |                                                |             |                                                |                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |                                                |                 | The second address line may not be greater than 45 characters. |
      | Check Character Limit for Location City field on Edit Hospital Organization page           | NO     | ACHNAME   |                                                                              |                                                |                                                |                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |             |                                                |                                                |                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst |                 | The City may not be greater than 45 characters.                |
