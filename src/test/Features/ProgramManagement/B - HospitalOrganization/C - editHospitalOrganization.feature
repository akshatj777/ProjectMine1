Feature: Edit Hospital organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit for Location Address1 field on Edit Hospital Organization page       | YES    | ACHNAME   |                                                                              | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst            |                                                |                                                           |                                                |                 |                                                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstabcasdfghjk |                                                           |                                                |                 | The first address line may not be greater than 55 characters.  |
      | Check Character Limit for Location Address2 field on Edit Hospital Organization page       | YES    | ACHNAME   |                                                                              |                                                           |                                                | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrst            |                                                |                 |                                                                                |                                                           | abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstabcasdfghjk |                                                |                 | The second address line may not be greater than 55 characters. |
  ...
  Scenario Outline: Edit a Hospital Organization With Mandatory Fields Missing
    ...
    Examples: 
      | Description                                                | Hosp_Name | Edited_Hospital_Name | Org_Address1 | City | State | Org_Postal_Code | Loc_Name | Loc_Address1 | Loc_City | Loc_State | Loc_Postal_Code |
      | Edit a Hospital Organization With Mandatory Fields Missing | ACHNAME   |                      |              |      |       |                 |          |              |          |           |                 |
