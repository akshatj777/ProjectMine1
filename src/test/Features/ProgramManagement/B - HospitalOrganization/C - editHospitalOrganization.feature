Feature: Edit Hospital organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check validation for blank Location Postal code | YES    | ACHNAME   | ACHNAME              | Address1 | City | California |           10000 | LocName  | LAddress1    | LCity    | California |                 | Please enter a Postal Code        |
