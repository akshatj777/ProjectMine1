Feature: Edit Hospital organization functionality tests
  ...
  Scenario Outline: Edit a Hospital Organization with duplicate Location details
    ...
    Examples: 
      ...
      | Add one more Location details on Edit Hospital Organization | NO     | ACHNAME   | Loc_Name123 | Loc_Address14 | Inpatient | Midwest    | Chicago    | Loc_Address24 | Loc_City1 | California |           10001 | Success! Hospital Organization Successfully Updated. |
