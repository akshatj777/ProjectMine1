Feature: Edit PGP organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit for Postal code field    | NO     | PGPNAME  |                                                                              |                                                                         |                                                |                                                                         |                                                | 10000-00000  | The address.postalCode format is invalid.                      |
      | Check Allowed Characters for Postal code field | YES    | PGPNAME  |                                                                              |                                                                         |                                                |                                                                         |                                                | abcdefghijkl | The address.postalCode format is invalid.                      |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Edit PGP Organization with Mandatory fields - Without MO                                                                                   | NO     |              | PGPNAME  | PGPNAME         |          |            |          |      |         |         |            |             | Success! PGP Organization Successfully Updated. |
      | Edit PGP Organization with Mandatory fields - With MO                                                                                      | YES    | MONAME       | PGPNAME  | PGPNAME         |          |            |          |      |         |         |            |             | Success! PGP Organization Successfully Updated. |
      | Edit PGP Organization with Mandatory fields + Address1 + Short Name + Address2 + City + State + Region + Market + postal Code - Without MO | NO     |              | PGPNAME  | PGPNAME         | Address1 | Short_Name | Address2 | City | Midwest | Chicago | California |       10000 | Success! PGP Organization Successfully Updated. |
      | Edit PGP Organization with Mandatory fields + Address1 + Short Name + City + State + Region + Market + postal Code - With MO               | YES    | MONAME       | PGPNAME  | PGPNAME         | Address1 | Short_Name |          | City | Midwest | Chicago | California |       10000 | Success! PGP Organization Successfully Updated. |
      | Edit PGP Organization with Mandatory fields + Address1 + Short Name + Address2 + City + State + postal Code- Without MO                    | NO     |              | PGPNAME  | PGPNAME         | Address1 | Short_Name | Address2 | City |         |         | California |       10001 | Success! PGP Organization Successfully Updated. |
      | Edit PGP Organization with all the available fields - Without MO                                                                           | NO     |              | PGPNAME  | PGPNAME         | Address1 | Short_Name | Address2 | City | Midwest | Chicago | California |       10000 | Success! PGP Organization Successfully Updated. |
      | Edit PGP Organization with all the available fields - With MO                                                                              | YES    | MONAME       | PGPNAME  | PGPNAME         | Address1 | Short_Name | Address2 | City | Midwest | Chicago | California |       10000 | Success! PGP Organization Successfully Updated. |
