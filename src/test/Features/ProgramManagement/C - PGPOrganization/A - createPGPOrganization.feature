Feature: Create PGP organization functionality tests.
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Create PGP Organization with Mandatory fields + Address1 + Address2 + City + State + postal Code + Region + Market- Without MO               | NO     | MONAME       | PGPNAME       | Address1 |            | Address2 | City |         |         |            |             | EIN |     | Success! PGP Organization Successfully Created.                                                         |
      ...
      | Create PGP Organization with all the available fields - Without MO                                                                           | NO    | MONAME       | PGPNAME       | Address1 | Short_Name | Address2 | City |         |         | California |       10000 | EIN | NPI | Success! PGP Organization Successfully Created.                                                         |
