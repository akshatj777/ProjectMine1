Feature: Search the PGP organizations functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Then I search "<PGP_Name> - <HasMO>" and verify with search list options on organization search box
    Then I serach with "<PGP_Name> - <Has_MO>" old name in organization search box
