...
public class PatientsPage extends BaseClass {
	...
	public void iClickTabInFilterBarOnPatientsPage(String elementTextXpath) {
		clickElement(driver.findElement(By
				.xpath("//button//span[contains(text(),'" + elementTextXpath
						+ "')]")));
	}

	public void iVerifyViewSectionOnPatientsPage(String elementText) {
		verifyTextForElement(
				driver.findElement(By.xpath("//span[text()='View:']")),
				elementText);
	}

	public void iVerifyViewAsActiveViewOnPatientsPage(By element) {
		verifyElementAttributeContainsValue(driver.findElement(element),
				"class", "active");
	}

	public void iVerifyToHaveViewOptionOnPatientsPage(By element,
			String viewOptions) {
		verifyElementAttributeContainsValue(driver.findElement(element),
				"ng-click", viewOptions);
	}
	...
	public void iEnterInPatientSearchFieldOnPatientsPage(String patientName) {
		iFillInText(driver.findElement(By
				.xpath("//div[@placeholder='Search Name']/div/input")),
				patientName);
	}

	public void iVerifyPatientSearchedResultContainsTextOnPatientPage(
			String patientNameText) {
		verifyTextForElementFromListByXpath(
				"//div[@class='card-header-content']/div/h3", patientNameText);
	}

	public void iVerifySeeAsPlaceholderForSearchOnPatientPage(String elementText) {
		verifyElementAttributeContainsValue(driver.findElement(By
				.cssSelector("i.valentino-icon-search ~ input")),
	...
	public void iVerifyElementTextPresentOnPatientPage(By byLocator,
			String elementText) {
	...
	public void iClickOnWorkistFilterOptionsOnPatientsPage(String worklistOption) {
		clickElement(driver.findElement(By
				.xpath("//button[span[span[contains(text(),'" + worklistOption
						+ "')]]]")));
	}

	public void iVerifyWorklistSubBarOptionsPresentOnPatientsPage(
			String worklistSubbar) {
		isElementVisible(driver.findElement(By
				.xpath("//button[span[span[contains(text(),'" + worklistSubbar
						+ "')]]]")));
	}

	public void iClickOnFilterButtonPresentOnPatientPage() {
		clickElement(driver.findElement(By
				.xpath("//button[@ng-click='toggleFilterDropdown($event)']")));
	}

	public void iVerifyDateRangeIsSelectedAsDefaultFilterUnderFilterOptions() {
		isElementVisible(driver.findElement(By
				.xpath("//span[text()='Date Range']")));
	}

	public void iVerifyCareSettingIsSelectedAsDefaultFilterUnderFilterOptions() {
		isElementVisible(driver.findElement(By
				.xpath("//span[text()='Care Setting']")));
	}

	public void iVerifyInitiatorIsSelectedAsDefaultFilterUnderFilterOptions() {
		isElementVisible(driver.findElement(By
				.xpath("//span[text()='Initiator']")));
	}
	...
	public void iVerifyOnboardingStatusIsPresentOnThePatientSummaryPage() {
		isElementVisible(driver.findElement(By
				.xpath("//label[text()='Onboarding Status']")));
	}
	...
	public void iVerifyRunServiceIsPresentInTheEligibilityDropdownOnThePatientSummaryPage() {
		isElementVisible(driver
				.findElement(By
						.xpath("//div[@id='eligibility_service']//a[@class='eligibility_verification']")));
	}

	public void iVerifyReviewServiceResponseIsPresentInTheEligibilityDropdownOnThePatientSummaryPage() {
		isElementVisible(driver.findElement(By
				.xpath("//a[@class='review_service_response']")));
	}
	...
	public void iClickOnAdmitReasonFilterPresentOnFilterPage() {
		clickElement(driver.findElement(By
				.cssSelector("div.filters-list>ul>li:nth-child(1)")));
	}

	public void i_type_in_the_search_field_on_patients_page(String admitReason) {
		iFillInText(
				driver.findElement(By.cssSelector("[name='admit-reason']")),
				admitReason);
	}

	public void iVerifyTheTotalNumberOfPatientsPresentOnThePatientsPage() {
		isElementVisible(driver.findElement(By
				.cssSelector(".controls-bar.ng-scope>div>strong")));
	}

	public void iClickOnDoneButtonPresentOnTheFilterPage() {
		clickElement(driver
				.findElement(By
						.cssSelector("button[class='btn btn-primary'][ng-click='closeFilters()']")));
	}

	public void iClickOnAnchorDischargeFacilityFilterPresentOnTheFilterPage() {
		clickElement(driver.findElement(By
				.cssSelector("div.filters-list>ul>li:nth-child(2)")));
	}

	public void iClickOnAnchorDischargeFacilityDropdownToSelectTheFaciltyOnTheFilterPage() {
		clickElement(driver.findElement(By
				.cssSelector(".form-control.dropdown-look")));
	}

	public void iTypeInTheSearchFieldToSearchTheAnchorDischargeFacilty(
			String Facility) {
		iFillInText(driver.findElement(By
				.cssSelector("input[placeholder='Name or Group*']")), Facility);
	}

	public void iSelectStamfordHospitalCheckboxPresentInTheFilterPage() {
		clickElement(driver
				.findElement(By
						.cssSelector("li.checkbox-item:nth-child(1)>div:nth-child(2)>label[for*='anchor-discharge-facility']")));
	}

	public void iClickOnAnchorFacilityFilterPresentInTheFilterPage() {
		clickElement(driver.findElement(By
				.cssSelector("div.filters-list>ul>li:nth-child(3)")));
	}
	...
	public void iClickOnExportButtonPresentOnThePatientPagetoExportThePatientList() {
		clickElement(driver.findElement(By
				.cssSelector("div.export-footer>button:nth-child(2)")));
	}

	public void iClickOnCarePlanFilterPresentOnFilterPage() {
		clickElement(driver.findElement(By
				.cssSelector("div.filters-list>ul>li:nth-child(4)")));
	}

	public void iClickOnCreatedRadioButtonPresentOnFilterPage() {
		clickElement(driver
				.findElement(By
						.cssSelector("input[id='careplanhas']~label[for='careplanhas']")));
	}

	public void iClickOnInpatientCheckboxUnderCareSettingPresentOnTheFilterPage() {
		clickElement(driver
				.findElement(By
						.cssSelector("input[id='care-settingHHH-I']~label[for='care-settingHHH-I']")));
	}

	public void iClickOnCooperationMetricFilterPresentOnTheFilterPage() {
		clickElement(driver.findElement(By
				.cssSelector("div.filters-list>ul>li:nth-child(6)")));
	}

	public void iClickOnNotAssignedCheckboxUnderCooperationMetricPresentOnTheFilterPage() {
		clickElement(driver
				.findElement(By
						.cssSelector("input[id='cooperation-metricsnull']~label[for='cooperation-metricsnull']")));
	}
	...
	public void iClickOnCurrentFacilityFilterPresentOnFilterPage() {
		clickElement(driver.findElement(By
				.cssSelector("div.filters-list>ul>li:nth-child(7)")));
	}
	...
	public void iClickOnDailyReportFilterPresentOnFilterPage() {
		clickElement(driver.findElement(By
				.cssSelector("div.filters-list>ul>li:nth-child(8)")));
	}

	public void iClickOnInpatientEpisodesRadioButtonPresentOnFilterPage() {
		clickElement(driver
				.findElement(By
						.cssSelector("input[id='daily-report0']~label[for='daily-report0']")));
	}

	public void iClickOnDateRangeDropdownPresentOnFilterPage() {
		clickElement(driver.findElement(By
				.cssSelector("div.dropdown-calendar>a>div")));
	}

	public void iClickOnDaysresentPresentOnFilterPage(int days) {
		clickElement(driver
				.findElement(By
						.cssSelector("div.tab-content>div:nth-child(1)>quick-range-selection>div>div>a:nth-child(4)")));
	}

	public void iClickOnAddPatientButtonPresentOnThePatientsPage() {
		clickElement(driver.findElement(By
				.cssSelector("button.btn.btn-primary.pull-right")));
	}

	public void iEnterDetailsInTextFieldPresentOnAddPatientModal(
			String detailFileds, String patientDetails) {
		iFillInText(
				driver.findElement(By.cssSelector("#Patient_Details_"
						+ detailFileds + "")), patientDetails);
	}
	...
	public void iSelecteOptionFromDropdownListPresentOnTheAddPatientPage(
			String detailFileds, String patientDetails) {
		clickElement(driver.findElement(By.cssSelector("#Patient_Details_"
				+ detailFileds + "")));
		selectDropdownVisibleElement("#Patient_Details_" + detailFileds + "",
				patientDetails);
	}

	public void iClickOnAdmittingFacilityPresentOnTheAddPatientPage() {
		clickElement(driver.findElement(By
				.cssSelector("a.select2-choice.select2-default")));
	}

	public void iSelectFromTheListOfAdmittingFacilityPresentOnTheAddPatientPage(
			String facility) {
		iFillInText(driver.findElement(By
				.cssSelector("div.select2-search>input.select2-input")),
				facility);
		longDelay();
		clickElement(driver
				.findElement(By
						.cssSelector("ul.select2-results>li>div#select2-result-label-2")));
	}
	...
	public void iClickOnCalenderButtonPresentOnTheAddPatientPage() {
		clickElement(driver
				.findElement(By
						.cssSelector("input#bp_personbundle_bpadmissiontype_admitDate")));
	}
	...
	public void iSelectInpatientFromAdmissionCareTypeDropdownPresentOnAddPatientPage(
			String careType) {
		selectDropdownVisibleElement(
				"#bp_personbundle_bpadmissiontype_admitCareType", careType);
	}
	...
	public void iVerifyAdmitDateIsPresentOnTheTransitionPage() {
		isElementVisible(driver.findElement(By
				.xpath("//td[@class='admit_date-column sorting_1']")));

	}

	public void iVerifyIsPresentOnTheTransitionPage(String text,
			String columnName) {
		isElementVisible(driver.findElement(By.xpath("//td[@class='"
				+ columnName + "' and text()='" + text + "']")));
	}

	public void iClickOnDRGTypeFilterPresentOnFilterPage() {
		clickElement(driver.findElement(By
				.cssSelector("div.filters-list>ul>li:nth-child(10)")));
	}

	public void iClickOnPossibleRadioButtonUnderDRGTypeFilter()
			throws Throwable {
		clickElement(driver
				.findElement(By.xpath("//label[@for='drg-typeP']/i")));
	}

	public void iClickOnEligibilityFilterPresentOnFilterPage() {
		clickElement(driver.findElement(By
				.cssSelector("div.filters-list>ul>li:nth-child(11)")));
	}

	public void iClickOnEligibileCheckboxUnderEligibleFilterOption()
			throws Throwable {
		clickElement(driver.findElement(By
				.xpath("//label[@for='eligibilityELIGIBLE']")));
	}

	public void iClickOnEpisodeDRGFilterPresentOnFilterPage() throws Throwable {
		clickElement(driver.findElement(By
				.cssSelector("div.filters-list>ul>li:nth-child(12)")));
	}

	public void iClickOnDrgTypeCheckboxUnderFilterOption() throws Throwable {
		clickElement(driver.findElement(By
				.xpath("//label[@for='episode-drg770']")));
	}

	public void iClickOnEpisodeStatusFilterPresentOnFilterPage()
			throws Throwable {
		clickElement(driver.findElement(By
				.cssSelector("div.filters-list>ul>li:nth-child(13)")));
	}

	public void iClickOnEpisodeStatusCheckboxUnderFilterOption()
			throws Throwable {
		clickElement(driver.findElement(By
				.xpath("//label[@for='episode-statusActive']")));
	}

	public void iClickOnFirstNameFilterPresentOnFilterPage() throws Throwable {
		clickElement(driver.findElement(By
				.cssSelector("div.filters-list>ul>li:nth-child(14)")));
	}

	public void iEnterUnderFirstNameFilter(String patient) throws Throwable {
		iFillInText(
				driver.findElement(By
	...
	public void iClickOnGenderFilterPresentOnFilterPage() throws Throwable {
		clickElement(driver.findElement(By
				.cssSelector("div.filters-list>ul>li:nth-child(15)")));
	}
