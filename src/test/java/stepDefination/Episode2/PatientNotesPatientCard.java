...
public class PatientNotesPatientCard extends DriverScript {
	...
	public void I_verify_that_usershould_be_able_to_select_and_upload_files_from_the_computer_through_Add_files_link(String file) throws AWTException, InterruptedException {
		String importDir = System.getProperty("user.dir");
		String newDir = importDir + "\\" + "src" + "\\" + "test" + "\\" + "Imports" + "\\" + file ;
		noteCreation.IverifythatusershouldbeabletoselectanduploadfilesfromthecomputerthroughAddfileslink(newDir);
	}
