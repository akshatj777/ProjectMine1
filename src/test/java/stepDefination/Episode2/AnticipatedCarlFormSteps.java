...
public class AnticipatedCarlFormSteps extends DriverScript {
	...
	public void I_Verify_Select_Text_In_PlaceHolder_Of_PhysicalTherapy_DropDown_On_PatientsRestorationPotential(
	...
	public void I_Verify_Upon_Select_Checkbox_SubFieldSection_Appears_Under_TransitionOfCareNeeds_On_AnticipatedDischargeNeeds(
			String text) throws Throwable {
		anticipatedcarlform
				.IVeriyUponSelectTheCheckBoxOptionSubFieldSectionAppearUnderTransitionOfCareNeedsOnAnticipatedDischargeNeeds(
						text);
	}

	@Then("^I verify on selecting \"([^\"]*)\" requierd field \"([^\"]*)\" appears for Transition of Care Needs$")
	public void I_Verify_Text_For_RequiredField_Upon_Selecting_Checkbox_Under_TransitionOfCareNeeds_On_AnticipatedDischargeNeeds(
			String text, String label) throws Throwable {
		anticipatedcarlform
				.IVeriyTextForRequiredFieldUponSelectingCheckBoxUnderTransitionOfCareNeedsOnAnticipatedDischargeNeeds(
						text, label);
	}

	@Then("^I verify \"([^\"]*)\" radio option appears under \"([^\"]*)\" for Transition Care Needs$")
	public void I_Verify_Radio_Option_Appears_Field_Upon_Selecting_Checkbox_Under_TransitionOfCareNeeds_On_AnticipatedDischargeNeeds(
			String radio, String text) throws Throwable {
		anticipatedcarlform
				.IVeriyRadioOptionsUponSelectingCheckBoxUnderTransitionOfCareNeedsOnAnticipatedDischargeNeeds(radio,
						text);
	}

	@Then("^I click \"([^\"]*)\" radio option under \"([^\"]*)\" for Transition Care Needs$")
	public void I_Click_Radio_Option_After_Selecting_Checkbox_Under_TransitionOfCareNeeds_On_AnticipatedDischargeNeeds(
			String radio, String text) throws Throwable {
		anticipatedcarlform
				.IClickRadioOptionAfterSelectingCheckBoxUnderTransitionOfCareNeedsOnAnticipatedDischargeNeeds(radio,
						text);
	}

	@Then("^I verify \"([^\"]*)\" radio option is checked under \"([^\"]*)\" for Transition Care Needs$")
	public void I_Verify_Checked_Radio_Option_UnderCheckbox_For_TransitionOfCareNeeds_On_AnticipatedDischargeNeeds(
			String radio, String text) throws Throwable {
		anticipatedcarlform
				.IVerifyCheckedRadioOptionUnderSelectedCheckBoxForTransitionOfCareNeedsOnAnticipatedDischargeNeeds(
						radio, text);
	}

	@Then("^I verify \"([^\"]*)\" radio option is not checked under \"([^\"]*)\" for Transition Care Needs$")
	public void I_Verify_UnChecked_Radio_Option_UnderCheckbox_For_TransitionOfCareNeeds_On_AnticipatedDischargeNeeds(
			String radio, String text) throws Throwable {
		anticipatedcarlform
				.IVerifyUnCheckedRadioOptionUnderSelectedCheckBoxForTransitionOfCareNeedsOnAnticipatedDischargeNeeds(
						radio, text);
	}

	@Then("^I verify on uncheck \"([^\"]*)\" checkbox subbar with options disaapear On Anticipated Discharge Needs$")
	public void I_Verify_On_UnChechk_Checkbox_SubBarOptions_DisAppears_On_AnticipatedDischargeNeeds(String text)
			throws Throwable {
		anticipatedcarlform
				.IVeriyUponUnSelectTheCheckBoxOptionSubFieldSectionDisAppearUnderTransitionOfCareNeedsOnAnticipatedDischargeNeeds(
						text);
	}

	@Then("^I verify \"([^\"])*\" radio is set to default on selecting \"([^\"]*)\" checkbox on Anticipated Discharge Needs$")
	public void I_Verify_Radio_Option_IsSet_To_Default_Under_Selected_Checkbox_For_TransitionOfCareNeeds_On_AnticipatedDischargeNeeds(
			String radio, String text) throws Throwable {
		anticipatedcarlform
				.IVerifyRadioOptionIsAtDefaultStateUnderSelectedCheckBoxForTransitionOfCareNeedsOnAnticipatedDischargeNeeds(
						radio, text);
	}
}
