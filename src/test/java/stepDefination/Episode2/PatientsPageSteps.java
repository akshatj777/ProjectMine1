...
public class PatientsPageSteps extends DriverScript {
	...
	public void i_should_see_tab_in_the_filter_bar_on_patients_page(
			String filterTabText) throws Throwable {
		patientsPage.iVerifyTabInFilterBarOnPatientsPage(filterTabText);

	}

	@When("^I click on \"([^\"]*)\" tab in the filter bar on patients page$")
	public void i_click_on_tab_in_the_filter_bar_on_patients_page(
			String filterTabText) throws Throwable {
	...
	public void i_should_see_view_as_active_view_on_patients_page(
			String viewOption) throws Throwable {
		patientsPage.iVerifyViewAsActiveViewOnPatientsPage(By
				.cssSelector("button.valentino-icon-" + viewOption + ""));
	}

	@Then("^I should have \"([^\"]*)\" view option on patients page$")
	public void i_sould_have_view_option_on_patients_page(String viewOption)
			throws Throwable {
		patientsPage.iVerifyToHaveViewOptionOnPatientsPage(
				By.cssSelector("button.valentino-icon-" + viewOption + ""),
				viewOption);
	}

	@When("^I select \"([^\"]*)\" view on patients page$")
	public void i_select_view_on_patients_page(String viewOption)
			throws Throwable {
		patientsPage.iClickViewOnPatientsPage("button.valentino-icon-"
				+ viewOption + "");
	}

	@When("^I type \"([^\"]*)\" in the patient search field on patients page$")
	public void i_type_in_the_patient_search_field_on_patients_page(
			String patientName) throws Throwable {
	...
	public void i_should_see_patient_searched_result_contains_on_patient_page(
			String patientText) throws Throwable {
		patientsPage
				.iVerifyPatientSearchedResultContainsTextOnPatientPage(patientText);
	}

	@Then("^I should see Filters button present on patients page$")
	public void i_should_see_filter_button_present_on_patient_page()
			throws Throwable {
		patientsPage.iVerifyElementTextPresentOnPatientPage(
				By.xpath("//button[span[span[contains(text(),'Filters')]]]"),
				"Filter");
	}

	@Then("^I should see \"([^\"]*)\" as placeholder for search on patients page$")
	public void i_Should_See_As_Placeholder_For_Search_On_Patient_Page(
			String patientText) throws Throwable {
	...
	public void i_should_see_the_total_patient_count_on_patient_page()
			throws Throwable {
		patientsPage.iVerifyElementPresentOnPatientPage(By
				.cssSelector("div.ng-scope>div>strong.ng-binding"));
	}

	@Then("^I should see Export feature present on patient page$")
	public void i_should_see_export_feature_present_on_patient_page()
			throws Throwable {
		patientsPage.iVerifyElementPresentOnPatientPage(By
				.cssSelector(".export-link>a"));
		patientsPage.iVerifyElementTextPresentOnPatientPage(
				By.cssSelector(".export-link>a"), "Export");
	}

	@Then("^I should see Sort by feature is present on patient page$")
	public void i_should_see_Sortby_feature_present_on_patient_page()
			throws Throwable {
		patientsPage.iVerifyElementTextPresentOnPatientPage(
				By.xpath("//strong[@class='sort-select-label']"), "Sort by:");
	}
	...
	public void i_should_see_Refresh_button_is_present() throws Throwable {
		patientsPage.iVerifyElementPresentOnPatientPage(By
				.cssSelector("button.btn-reload"));
	}

	@Then("^I verify Add Patient button is present on patients page$")
	public void i_verify_Add_Patient_button_is_present_on_patients_page()
			throws Throwable {
		patientsPage.iVerifyElementPresentOnPatientPage(By
				.xpath("//button[contains(text(),'Add Patient')]"));
	}

	@Then("^I verify \"([^\"]*)\" Patient Cards are present on patients page$")
	public void i_verify_Patient_Cards_are_present_on_patients_page(int Count)
			throws Throwable {
	...
	public void i_click_on_worklist_filter_option_on_the_patients_page(
			String worklistFilter) throws Throwable {
	...
	public void i_should_verify_worklist_sub_bar_option_on_the_patients_page(
			String worklistSubbar) throws Throwable {
		patientsPage
				.iVerifyWorklistSubBarOptionsPresentOnPatientsPage(worklistSubbar);
	}

	@Then("^I click on Done button present on the Filter Page$")
	public void i_click_on_Done_button_present_on_the_Filter_Page()
			throws Throwable {
	...
	public void i_click_on_Anchor_Discharge_Facility_Filter_present_on_Filter_Page()
			throws Throwable {
		patientsPage
				.iClickOnAnchorDischargeFacilityFilterPresentOnTheFilterPage();
	}

	@When("^I click on Anchor Discharge Facility dropdown to select the Facilty on the Filter Page$")
	public void i_click_on_Anchor_Discharge_Facility_dropdown_to_select_the_Facilty_on_the_Filter_Page()
			throws Throwable {
		patientsPage
				.iClickOnAnchorDischargeFacilityDropdownToSelectTheFaciltyOnTheFilterPage();
	}

	@When("^I type \"([^\"]*)\" in the search field to search the Anchor Discharge Facilty$")
	public void i_type_in_the_search_field_to_search_the_Anchor_Discharge_Facilty(
			String Facility) throws Throwable {
		patientsPage
				.iTypeInTheSearchFieldToSearchTheAnchorDischargeFacilty(Facility);
	}

	@When("^I select Stamford hospital checkbox present in the Filter Page$")
	public void i_select_Stamford_hospital_checkbox_present_in_the_Filter_Page()
			throws Throwable {
	...
	public void i_click_on_Anchor_Facility_Filter_present_on_Filter_Page()
			throws Throwable {
	...
	public void i_click_on_Anchor_Facility_dropdown_to_select_the_Facilty_on_the_Filter_Page()
			throws Throwable {
		patientsPage
				.iClickOnAnchorFacilityDropdownToSelectTheFaciltyOnTheFilterPage();
	}

	@When("^I type \"([^\"]*)\" in the search field to search the Anchor Facility$")
	public void i_type_in_the_search_field_to_search_the_Anchor_Facilty(
			String facility) throws Throwable {
	...
	public void i_select_Stamford_hospital_checkbox_as_Anchor_Facility_present_in_the_Filter_Page()
			throws Throwable {
		patientsPage
				.iSelectStamfordHospitalCheckboxAsAnchorFacilityPresentInTheFilterPage();
	}

	@Then("^I verify Medicare ID Filter is displayed under List of Filter Options$")
	public void i_verify_Medicare_ID_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
	...
	public void i_verify_Payer_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
	...
	public void i_verify_Quality_Metric_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyQualityMetricFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify Readmission Count Filter is displayed under List of Filter Options$")
	public void i_verify_Readmission_Count_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyReadmissionCountFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify Risk Assessment Filter is displayed under List of Filter Options$")
	public void i_verify_Risk_Assessment_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyRiskAssessmentFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify SSN Filter is displayed under List of Filter Options$")
	public void i_verify_SSN_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
	...
	public void i_verify_Tags_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
	...
	public void i_verify_Patient_Name_is_present_in_the_patient_card_header_on_patient_page()
			throws Throwable {
		patientsPage
				.iVerifyPatientNameIsPresentInThePatientCardHeaderOnPatientPage();
	}

	@Then("^I verify DOB is present on the patient card header on the patient page$")
	public void i_verify_DOB_is_present_on_the_patient_card_header_on_the_patient_page()
			throws Throwable {
	...
	public void i_verify_Age_is_present_on_the_patient_card_header_on_the_patient_page()
			throws Throwable {
	...
	public void i_verify_Gender_is_present_on_the_patient_card_header_on_the_patient_page()
			throws Throwable {
		patientsPage
				.iVerifyGenderIsPresentInThePatientCardHeaderOnPatientPage();
	}

	@Then("^I verify SSN is present on the patient card header on the patient page$")
	public void i_verify_SSN_is_present_on_the_patient_card_header_on_the_patient_page()
			throws Throwable {
	...
	public void i_verify_Expand_button_is_present_on_the_patient_card_header_on_the_patient_page()
			throws Throwable {
		patientsPage
				.iVerifyExpandButtonIsPresentInThePatientCardHeaderOnPatientPage();
	}

	@Then("^I verify risk status is present on the patient card on the patient page$")
	public void i_verify_risk_status_is_present_on_the_patient_card_on_the_patient_page()
			throws Throwable {
	...
	public void i_verify_current_location_is_present_on_the_patient_card_on_the_patient_page()
			throws Throwable {
		patientsPage
				.iVerifyCurrentLocationIsPresentOnThePatientCardOnPatientPage();
	}

	@Then("^I verify anchor facility is present on the patient card on the patient page$")
	public void i_verify_anchor_facility_is_present_on_the_patient_card_on_the_patient_page()
			throws Throwable {
		patientsPage
				.iVerifyAnchorFacilityIsPresentOnThePatientCardOnPatientPage();
	}

	@Then("^I verify tags is present on the patient card on the patient page$")
	public void i_verify_tags_is_present_on_the_patient_card_on_the_patient_page()
			throws Throwable {
	...
	public void i_verify_Quick_Actions_is_present_on_the_patient_card_on_the_patient_page()
			throws Throwable {
		patientsPage
				.iVerifyQuickActionsIsPresentOnThePatientCardOnPatientPage();
	}

	@When("^I click on the Expand button on the patient card on the patient page$")
	public void i_click_on_the_Expand_button_on_the_patient_card_on_the_patient_page()
			throws Throwable {
	...
	public void i_verify_Quick_action_button_Add_Clinical_Document_New_Task_is_present_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyQuickActionButtonAddClinicalDocumentAndNewTaskIsPresentOnThePatientSummaryPage();
	}

	@Then("^I Verify Current Location is present on the patient summary page$")
	public void i_Verify_Current_Location_is_present_on_the_patient_summary_page()
			throws Throwable {
	...
	public void i_Verify_Anchor_Facility_is_present_on_the_patient_summary_page()
			throws Throwable {
	...
	public void i_Verify_Account_status_is_present_on_the_patient_summary_page()
			throws Throwable {
	...
	public void i_Verify_MRNs_is_present_on_the_patient_summary_page()
			throws Throwable {
	...
	public void i_Verify_Onboarding_Status_is_present_on_the_patient_summary_page()
			throws Throwable {
	...
	public void i_Click_on_Onboarding_Status_present_on_the_patient_summary_page()
			throws Throwable {
	...
	public void i_Verify_Recalculate_is_present_in_the_Onboarding_Dropdown_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyRecalculateIsPresentInTheOnboardingDropdownOnThePatientSummaryPage();
	}

	@Then("^I Verify Low Status is present in the Onboarding Dropdown on the patient summary page$")
	public void i_Verify_Low_Status_is_present_in_the_Onboarding_Dropdown_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyLowStatusIsPresentInTheOnboardingDropdownOnThePatientSummaryPage();
	}

	@Then("^I Verify High Status is present in the Onboarding Dropdown on the patient summary page$")
	public void i_Verify_High_Status_is_present_in_the_Onboarding_Dropdown_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyHighStatusIsPresentInTheOnboardingDropdownOnThePatientSummaryPage();
	}

	@Then("^I Verify Needs-Onboarding Status in the Onboarding Dropdown on the patient summary page$")
	public void i_Verify_Needs_Onboarding_Status_in_the_Onboarding_Dropdown_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyNeedsOnboardingStatusIsPresentInTheOnboardingDropdownOnThePatientSummaryPage();
	}

	@Then("^I Verify Not-Onboarded Status is present in the Onboarding Dropdown on the patient summary page$")
	public void i_Verify_Not_Onboarded_Status_is_present_in_the_Onboarding_Dropdown_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyNotOnboardedStatusIsPresentInTheOnboardingDropdownOnThePatientSummaryPage();
	}

	@Then("^I Verify Eligibility is present on the patient summary page$")
	public void i_Verify_Eligibility_is_present_on_the_patient_summary_page()
			throws Throwable {
	...
	public void i_Click_on_Eligibility_present_on_the_patient_summary_page()
			throws Throwable {
	...
	public void i_Verify_Run_Service_is_present_in_the_Eligibility_Dropdown_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyRunServiceIsPresentInTheEligibilityDropdownOnThePatientSummaryPage();
	}

	@Then("^I Verify Review Service Response is present in the Eligibility Dropdown on the patient summary page$")
	public void i_Verify_Review_Service_Response_is_present_in_the_Eligibility_Dropdown_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyReviewServiceResponseIsPresentInTheEligibilityDropdownOnThePatientSummaryPage();
	}

	@Then("^I Verify Reset Payer section is present in the Eligibility Dropdown on the patient summary page$")
	public void i_Verify_Reset_Payer_section_is_present_in_the_Eligibility_Dropdown_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyResetPayerSectionIsPresentInTheEligibilityDropdownOnThePatientSummaryPage();
	}

	@Then("^I Verify Eligible is present in the Eligibility Dropdown on the patient summary page$")
	public void i_Verify_Eligible_is_present_in_the_Eligibility_Dropdown_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyEligibleIsPresentInTheEligibilityDropdownOnThePatientSummaryPage();
	}

	@Then("^I Verify Not Eligible is present in the Eligibility Dropdown on the patient summary page$")
	public void i_Verify_Not_Eligible_is_present_in_the_Eligibility_Dropdown_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyNotEligibleIsPresentInTheEligibilityDropdownOnThePatientSummaryPage();
	}

	@Then("^I Verify Not Eligible ESRD is present in the Eligibility Dropdown on the patient summary page$")
	public void i_Verify_Not_Eligible_ESRD_is_present_in_the_Eligibility_Dropdown_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyNotEligibleESRDIsPresentInTheEligibilityDropdownOnThePatientSummaryPage();
	}

	@Then("^I Verify Error is present in the Eligibility Dropdown on the patient summary page$")
	public void i_Verify_Error_is_present_in_the_Eligibility_Dropdown_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyErrorIsPresentInTheEligibilityDropdownOnThePatientSummaryPage();
	}

	@Then("^I Verify Expired is present in the Eligibility Dropdown on the patient summary page$")
	public void i_Verify_Expired_is_present_in_the_Eligibility_Dropdown_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyExpiredIsPresentInTheEligibilityDropdownOnThePatientSummaryPage();
	}

	@Then("^I Verify Tags is present on the patient summary page$")
	public void i_Verify_Tags_is_present_on_the_patient_summary_page()
			throws Throwable {
	...
	public void i_click_on_Hide_Summary_button_present_on_the_patient_summary_page()
			throws Throwable {
	...
	public void i_verify_that_only_Card_header_information_is_displayed_on_the_patient_summary_page()
			throws Throwable {
		patientsPage
				.iVerifyThatOnlyCardHeaderInformationIsDisplayedOnThePatientSummaryPage();
	}

	@Then("^I click on the gear icon present on the patient overview page\\.$")
	public void i_click_on_the_gear_icon_present_on_the_patient_overview_page()
			throws Throwable {
	...
	public void i_verify_Edit_button_is_present_on_the_patient_overview_page()
			throws Throwable {
	...
	public void i_verify_Delete_button_is_present_on_the_patient_overview_page()
			throws Throwable {
	...
	public void i_verify_Assign_button_is_present_on_the_patient_overview_page()
			throws Throwable {
	...
	public void i_verify_Attach_Note_button_is_present_on_the_patient_overview_page()
			throws Throwable {
	...
	public void i_verify_Start_CARL_Tool_button_is_present_on_the_patient_overview_page()
			throws Throwable {
		patientsPage
				.iVerifyStartCARLToolButtonIsPresentOnThePatientOverviewPage();
	}

	@When("^I click on Edit option present under gear icon present on the transition table$")
	public void i_click_on_Edit_option_present_under_gear_icon_present_on_the_transition_table()
			throws Throwable {
		patientsPage
				.iClickOnEditOptionPresentUnderGearIconDropdownMenuPresentOnTheTransitionTable();
	}

	@Then("^I verify Transition Info is present under Transition Tab present on the patient overview page$")
	public void i_verify_Transition_Info_is_present_under_Transition_Tab_present_on_the_patient_overview_page()
			throws Throwable {
		patientsPage
				.iVerifyTransitionInfoIsPresentUnderTransitionTabPresentOnThePatientOverviewPage();
	}

	@Then("^I verify Diagnosis and DRG is present under Transition Tab present on the patient overview page$")
	public void i_verify_Diagnosis_and_DRG_is_present_under_Transition_Tab_present_on_the_patient_overview_page()
			throws Throwable {
		patientsPage
				.iVerifyDiagnosisAndDRGIsPresentUnderTransitionTabPresentOnThePatientOverviewPage();
	}

	@Then("^I verify Treatment Info is present under Transition Tab present on the patient overview page$")
	public void i_verify_Treatment_Info_is_present_under_Transition_Tab_present_on_the_patient_overview_page()
			throws Throwable {
		patientsPage
				.iVerifyTreatmentInfoIsPresentUnderTransitionTabPresentOnThePatientOverviewPage();
	}

	@Then("^I verify Comment is present under Transition Tab present on the patient overview page$")
	public void i_verify_Comment_is_present_under_Transition_Tab_present_on_the_patient_overview_page()
			throws Throwable {
		patientsPage
				.iVerifyCommentIsPresentUnderTransitionTabPresentOnThePatientOverviewPage();
	}

	@Then("^I verify TCRN Checklist is present under Transition Tab present on the patient overview page$")
	public void i_verify_TCRN_Checklist_is_present_under_Transition_Tab_present_on_the_patient_overview_page()
			throws Throwable {
		patientsPage
				.iVerifyTCRNChecklistIsPresentUnderTransitionTabPresentOnThePatientOverviewPage();
	}

	@When("^I click on Diagnosis and DRG tab present on the patient overview page$")
	public void i_click_on_Diagnosis_and_DRG_tab_present_on_the_patient_overview_page()
			throws Throwable {
		patientsPage
				.iClickOnDiagnosisAndDRGTabPresentOnThePatientOverviewPage();
	}

	@Then("^I verify ICD is present in the Diagnosis and DRG tab$")
	public void i_verify_ICD_is_present_in_the_Diagnosis_and_DRG_tab()
			throws Throwable {
		patientsPage.iVerifyICDIsPresentInTheDiagnosisAndDRGTab();
	}

	@Then("^I verify Predict DRG is present in the Diagnosis and DRG tab$")
	public void i_verify_Predict_DRG_is_present_in_the_Diagnosis_and_DRG_tab()
			throws Throwable {
	...
	public void i_verify_Add_a_New_DRG_is_present_in_the_Diagnosis_and_DRG_tab()
			throws Throwable {
	...
	public void i_click_on_DRG_Type_to_Add_a_New_DRG_present_on_the_patient_overview_page()
			throws Throwable {
		patientsPage
				.iClickOnDRGTypeToAddANewDRGPresentOnThePatientOverviewPage();
	}

	@Then("^I select Possible from the DRG type dropdown present on the patient overview page$")
	public void i_select_Possible_from_the_DRG_type_dropdown_present_on_the_patient_overview_page()
			throws Throwable {
		patientsPage
				.iSelectPossibleFromTheDRGTypeDropdownPresentOnThePatientOverviewPage();
	}

	@Then("^I Click on DRG dropdown menu present on the patient overview page$")
	public void i_Click_on_DRG_dropdown_menu_present_on_the_patient_overview_page()
			throws Throwable {
	...
	public void i_Search_DRG_on_the_search_box_on_the_DRG_present_on_the_patient_overview_page(
			int DRG) throws Throwable {
		patientsPage
				.iSearchDRGOnTheSearchBoxOnTheDRGPresentOnThePatientOverviewPage(DRG);
	}

	@Then("^I select RESPIRATORY INFECTIONS & INFLAMATIONS from the DRG list present on the patient overview page$")
	public void i_select_RESPIRATORY_INFECTIONS_INFLAMATIONS_from_the_DRG_list_present_on_the_patient_overview_page()
			throws Throwable {
		patientsPage
				.iSelectRespiratoryInfectionsInflationsFromTheDRGListPresentOnThePatientOverviewPage();
	}

	@Then("^I click on Update Transition button present on the patient overview page$")
	public void i_click_on_Update_Transition_button_present_on_the_patient_overview_page()
			throws Throwable {
		patientsPage
				.iClickOnUpdateTransitionButtonPresentOnThePatientOverviewPage();
	}

	@When("^I click on Last Name present on the Filter Page$")
	public void i_click_on_Last_Name_present_on_the_Filter_Page()
			throws Throwable {
		patientsPage.iClickOnLastNamePresentOnTheFilterPage();
	}

	@When("^I click on export button present on the Patient Page$")
	public void i_click_on_export_button_present_on_the_Patient_Page()
			throws Throwable {
		patientsPage.iClickOnExportButtonPresentOnThePatientPage();
	}

	@When("^I click on Select All checkbox present on the Patient Page$")
	public void i_click_on_Select_All_checkbox_present_on_the_Patient_Page()
			throws Throwable {
	...
	public void i_click_on_Export_button_present_on_the_Patient_Page_to_export_the_Patient_List()
			throws Throwable {
		patientsPage
				.iClickOnExportButtonPresentOnThePatientPagetoExportThePatientList();
	}

	@When("^I click on Filter button present on Patient Page$")
	public void i_click_on_Filter_button_present_on_Patient_Page()
			throws Throwable {
		patientsPage.iClickOnFilterButtonPresentOnPatientPage();
	}

	@When("^I click on Filters button present on Filter Page$")
	public void i_click_on_Filters_button_present_on_Filter_Page()
			throws Throwable {
	...
	public void i_verify_Admit_Reason_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyAdmitReasonFilterIsDisplayedUnderListofFilterOptions();
	}

	@Then("^I verify Anchor Discharge Facility Filter is displayed under List of Filter Options$")
	public void i_verify_Anchor_Discharge_Facility_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyAnchorDischargeFacilityFilterIsDisplayedUnderListofFilterOptions();
	}

	@Then("^I verify the total number of patients present on the Patients Page$")
	public void i_verify_the_total_number_of_patients_present_on_the_Patients_Page()
			throws Throwable {
	...
	public void i_verify_Anchor_Facility_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyAnchorFacilityFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify Care Plan Filter is displayed under List of Filter Options$")
	public void i_verify_Care_Plan_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
	...
	public void i_verify_Care_Setting_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyCareSettingFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify Cooperation Metric Filter Filter is displayed under List of Filter Options$")
	public void i_verify_Cooperation_Metric_Filter_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyCooperationMetricFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify Current Facility Filter is displayed under List of Filter Options$")
	public void i_verify_Current_Facility_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyCurrentFacilityFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify Daily Report Filter is displayed under List of Filter Options$")
	public void i_verify_Daily_Report_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyDailyReportFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify Date Range Filter is displayed under List of Filter Options$")
	public void i_verify_Date_Range_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyDateRangeFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify DRG Type Filter is displayed under List of Filter Options$")
	public void i_verify_DRG_Type_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
	...
	public void i_verify_Eligibility_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyEligibilityFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify Episode DRG Filter is displayed under List of Filter Options$")
	public void i_verify_Episode_DRG_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyEpisodeDRGFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify Episode Status Filter is displayed under List of Filter Options$")
	public void i_verify_Episode_Status_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyEpisodeStatusFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify Date Range is selected as default filter under Filter options$")
	public void i_verify_Date_Range_is_selected_as_default_filter_under_Filter_options()
			throws Throwable {
		patientsPage
				.iVerifyDateRangeIsSelectedAsDefaultFilterUnderFilterOptions();
	}

	@Then("^I verify Care Setting is selected as default filter under Filter options$")
	public void i_verify_Care_Setting_is_selected_as_default_filter_under_Filter_options()
			throws Throwable {
		patientsPage
				.iVerifyCareSettingIsSelectedAsDefaultFilterUnderFilterOptions();
	}

	@Then("^I verify Initiator is selected as default filter under Filter options$")
	public void i_verify_Initiator_is_selected_as_default_filter_under_Filter_options()
			throws Throwable {
		patientsPage
				.iVerifyInitiatorIsSelectedAsDefaultFilterUnderFilterOptions();
	}

	@Then("^I verify First Name Filter is displayed under List of Filter Options$")
	public void i_verify_First_Name_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyFirstNameFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify Gender Filter is displayed under List of Filter Options$")
	public void i_verify_Gender_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
	...
	public void i_verify_Initiator_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyInitiatorFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify Inpatient Location Filter is displayed under List of Filter Options$")
	public void i_verify_Inpatient_Location_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyInpatientLocationFilterIsDisplayedUnderListOfFilterOptions();
	}

	@Then("^I verify Last Name Filter is displayed under List of Filter Options$")
	public void i_verify_Last_Name_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
	...
	public void i_verify_Filter_is_displayed_under_List_of_Filter_Options(
			String arg1) throws Throwable {
	}

	@When("^I click on Admit Reason Filter present on Filter Page$")
	public void i_click_on_Admit_Reason_Filter_present_on_Filter_Page()
			throws Throwable {
	...
	public void i_click_on_Care_Plan_Filter_present_on_Filter_Page()
			throws Throwable {
		patientsPage.iClickOnCarePlanFilterPresentOnFilterPage();
	}

	@When("^I click on created radio button present on Filter Page$")
	public void i_click_on_created_radio_button_present_on_Filter_Page()
			throws Throwable {
	...
	public void i_click_on_Inpatient_checkbox_under_care_setting_present_on_the_Filter_Page()
			throws Throwable {
		patientsPage
				.iClickOnInpatientCheckboxUnderCareSettingPresentOnTheFilterPage();
	}

	@Then("^I verify Cooperation Metric Filter is displayed under List of Filter Options$")
	public void i_verify_Cooperation_Metric_Filter_is_displayed_under_List_of_Filter_Options()
			throws Throwable {
		patientsPage
				.iVerifyCooperationMetricFilterDisplayedUnderListOfFilterOptions();
	}

	@When("^I click on Cooperation Metric Filter present on Filter Page$")
	public void i_click_on_Cooperation_Metric_Filter_present_on_Filter_Page()
			throws Throwable {
	...
	public void i_Click_on_Not_assigned_checkbox_under_Cooperation_Metric_present_on_the_Filter_Page()
			throws Throwable {
		patientsPage
				.iClickOnNotAssignedCheckboxUnderCooperationMetricPresentOnTheFilterPage();
	}

	@When("^I click on Current Facility Filter present on Filter Page$")
	public void i_click_on_Current_Facility_Filter_present_on_Filter_Page()
			throws Throwable {
	...
	public void i_click_on_Current_Facility_dropdown_present_on_Filter_Page()
			throws Throwable {
	...
	public void i_click_on_Daily_Report_Filter_present_on_Filter_Page()
			throws Throwable {
	...
	public void i_click_on_Inpatient_Episodes_radio_button_present_on_Filter_Page()
			throws Throwable {
	...
	public void i_enter_in_the_first_name_text_box_present_on_the_Add_Patient_page(
			String firstname) throws Throwable {
		patientsPage.iEnterDetailsInTextFieldPresentOnAddPatientModal(
				"firstName", firstname);
	}

	@Then("^I enter  \"([^\"]*)\" in the last name text box present on the Add Patient page$")
	public void i_enter_in_the_last_name_text_box_present_on_the_Add_Patient_page(
	...
	public void i_enter_date_of_birth_present_on_the_Add_Patient_Page(
			String dateOfBirth) throws Throwable {
		patientsPage.iEnterDetailsInTextFieldPresentOnAddPatientModal("dob",
				dateOfBirth);
	}

	@Then("^I selected \"([^\"]*)\" from the gender drop down list present on the Add Patient page$")
	public void i_selected_from_the_gender_drop_down_list_present_on_the_Add_Patient_page(
			String gender) throws Throwable {
		patientsPage.iSelecteOptionFromDropdownListPresentOnTheAddPatientPage(
				"gender", gender);
	}

	@When("^I click on Admitting Facility present on the Add Patient page$")
	public void i_click_on_Admitting_Facility_present_on_the_Add_Patient_page()
			throws Throwable {
	...
	public void i_Select_from_the_list_of_admitting_facility_present_on_the_Add_Patient_page(
			String facility) throws Throwable {
		patientsPage
				.iSelectFromTheListOfAdmittingFacilityPresentOnTheAddPatientPage(facility);
	}

	@When("^I enter \"([^\"]*)\" in the Medicare ID present on the Add Patient page$")
	public void i_enter_in_the_Medicare_ID_present_on_the_Add_Patient_page(
			String medicareID) throws Throwable {
		patientsPage.iEnterDetailsInTextFieldPresentOnAddPatientModal(
				"medicareId", medicareID);
	}

	@Then("^I click on the next button present on the Add Patient page$")
	public void i_click_on_the_next_button_present_on_the_Add_Patient_page()
			throws Throwable {
	...
	public void i_click_on_Calender_button_present_on_the_Add_Patient_page()
			throws Throwable {
	...
	public void i_select_from_the_care_type_drop_down_menu_present_on_the_Add_Patient_page(
			String careType) throws Throwable {
		patientsPage
				.iSelectInpatientFromAdmissionCareTypeDropdownPresentOnAddPatientPage(careType);
	}

	@When("^I click on Add Transition button present on the Add Patient page$")
	public void i_click_on_Add_Transition_button_present_on_the_Add_Patient_page()
			throws Throwable {
	...
	public void i_click_on_Agree_button_present_on_the_Attestation_page()
			throws Throwable {
		// open bug
	...
	public void i_verify_text_is_present_on_the_add_patient_page(String text)
			throws Throwable {
		patientsPage.iVerifyTextIsPresentOnTheAddPatientPage(text);
	}

	@Then("^I verify \"([^\"]*)\"  is present \"([^\"]*)\" on the transition page$")
	public void i_verify_is_present_on_the_transition_page(String text,
	...
	public void i_click_on_eligibility_Filter_present_on_Filter_Page()
			throws Throwable {
		patientsPage.iClickOnEligibilityFilterPresentOnFilterPage();
	}

	@Then("^I click on eligible checkbox under eligible filter option$")
	public void i_click_on_eligibile_checkbox_under_eligible_filter_option()
			throws Throwable {
	...
	public void i_click_on_episode_DRG_Filter_present_on_Filter_Page()
			throws Throwable {
		patientsPage.iClickOnEpisodeDRGFilterPresentOnFilterPage();
	}

	@Then("^I click on drg type checkbox under filter option$")
	public void i_click_on_drg_type_checkbox_under_filter_option()
			throws Throwable {
	...
	public void i_click_on_episode_status_Filter_present_on_Filter_Page()
			throws Throwable {
		patientsPage.iClickOnEpisodeStatusFilterPresentOnFilterPage();
	}

	@Then("^I click on episode status checkbox under filter option$")
	public void i_click_on_episode_status_checkbox_under_filter_option()
			throws Throwable {
	...
	public void i_click_on_first_name_Filter_present_on_Filter_Page()
			throws Throwable {
		patientsPage.iClickOnFirstNameFilterPresentOnFilterPage();
	}

	@Then("^I enter \"([^\"]*)\" under first name filter$")
	public void i_enter_under_first_name_filter(String patient)
			throws Throwable {
	...
	public void i_click_on_gender_Filter_present_on_Filter_Page()
			throws Throwable {
		patientsPage.iClickOnGenderFilterPresentOnFilterPage();
	}

	@When("^I select the gender from the gender filter list$")
	public void i_select_the_gender_from_the_gender_filtr_list()
			throws Throwable {
