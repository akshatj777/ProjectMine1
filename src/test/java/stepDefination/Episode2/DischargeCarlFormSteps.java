...
public class DischargeCarlFormSteps extends DriverScript {
	...
	@Then("^I verify \"([^\"]*)\" field under \"([^\"]*)\" on Discharge section$")
	public void I_Verify_Subtitle_Field_under_on_Discharge_section(String text, String text1) throws Throwable {
	    dischargecarlform.IVerifySubtitleUnderDischargeSectionOnDishargeTabOfTheCarlForm(text, text1);
	}
