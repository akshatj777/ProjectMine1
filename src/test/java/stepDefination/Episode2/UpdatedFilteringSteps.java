...
public class UpdatedFilteringSteps extends DriverScript {
	...
	public void I_Verify_that_Clinical_Documents_Filters_link_should_display_filters_as_below_with_the_correct_syntax_and_sequence()
			throws Throwable {
		patientclinical
				.IVerifythatClinicalDocumentsFilterslinkshoulddisplayfiltersasbelowwiththecorrectsyntaxandsequence();
	}
	...
	public void I_Verify_that_clicking_Clinical_Documents_Filters_link_should_show_the_title_document_that_has_list_of_document_forms_in_it()
			throws Throwable {
		patientclinical
				.IVerifythatclickingClinicalDocumentsFilterslinkshouldshowthetitledocumentthathaslistofdocumentformsinit();
	}
