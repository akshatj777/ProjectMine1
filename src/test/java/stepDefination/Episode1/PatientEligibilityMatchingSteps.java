...
public void i_select_an_admit_date() throws Throwable
{
	patienteligibility.iSelectAnAdmitDate();
}
@Then("^I select care type$")
public void i_select_care_type()
{
	patienteligibility.iSelectCareType();
}
@And("^I search for ([^\"]*) Admit Facility$")
public void i_search_for_admit_facility(String searchText) throws Throwable {
	patienteligibility.iSearchforAdmitFacility(searchText);
}
